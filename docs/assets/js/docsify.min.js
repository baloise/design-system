...
!function () {
  ...
  var De = xe(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
      ...
      Qe = $(/^(?:\w+script|data):/i),
      Je = $(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g),
      et = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
    return _typeof(e);
  } : function (e) {
  ...
  var P,
    ...
    function L(e) {
      pe && pe === e || (e && "object" === (void 0 === e ? "undefined" : et(e)) || (e = {}), j = "ALLOWED_TAGS" in e ? Ne({}, e.ALLOWED_TAGS) : H, I = "ALLOWED_ATTR" in e ? Ne({}, e.ALLOWED_ATTR) : q, ce = "ADD_URI_SAFE_ATTR" in e ? Ne(Pe(ue), e.ADD_URI_SAFE_ATTR) : ue, U = "FORBID_TAGS" in e ? Ne({}, e.FORBID_TAGS) : {}, B = "FORBID_ATTR" in e ? Ne({}, e.FORBID_ATTR) : {}, oe = "USE_PROFILES" in e && e.USE_PROFILES, Z = !1 !== e.ALLOW_ARIA_ATTR, W = !1 !== e.ALLOW_DATA_ATTR, Y = e.ALLOW_UNKNOWN_PROTOCOLS || !1, G = e.SAFE_FOR_JQUERY || !1, V = e.SAFE_FOR_TEMPLATES || !1, X = e.WHOLE_DOCUMENT || !1, J = e.RETURN_DOM || !1, ee = e.RETURN_DOM_FRAGMENT || !1, te = e.RETURN_DOM_IMPORT || !1, ne = e.RETURN_TRUSTED_TYPE || !1, Q = e.FORCE_BODY || !1, re = !1 !== e.SANITIZE_DOM, ie = !1 !== e.KEEP_CONTENT, ae = e.IN_PLACE || !1, D = e.ALLOWED_URI_REGEXP || D, V && (W = !1), ee && (J = !0), oe && (j = Ne({}, [].concat(tt(qe))), I = [], !0 === oe.html && (Ne(j, De), Ne(I, Ue)), !0 === oe.svg && (Ne(j, je), Ne(I, Be), Ne(I, We)), !0 === oe.svgFilters && (Ne(j, He), Ne(I, Be), Ne(I, We)), !0 === oe.mathMl && (Ne(j, Ie), Ne(I, Ze), Ne(I, We))), e.ADD_TAGS && (j === H && (j = Pe(j)), Ne(j, e.ADD_TAGS)), e.ADD_ATTR && (I === q && (I = Pe(I)), Ne(I, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && Ne(ce, e.ADD_URI_SAFE_ATTR), ie && (j["#text"] = !0), X && Ne(j, ["html", "head", "body"]), j.table && (Ne(j, ["tbody"]), delete U.tbody), xe && xe(e), pe = e);
    }
    ...
    function $(e) {
      ...
      return e && n && t.body.insertBefore(l.createTextNode(n), t.body.childNodes[0] || null), S.call(t, X ? "html" : "body")[0];
    }
    ...
    function me(e) {
      ...
      if (ge("uponSanitizeElement", e, {
        tagName: n,
        allowedTags: j
      }), ("svg" === n || "math" === n) && 0 !== e.querySelectorAll("p, br").length) return R(e), !0;
      if (j[n] && !U[n]) return "noscript" === n && ze(/<\/noscript/i, e.innerHTML) ? (R(e), !0) : "noembed" === n && ze(/<\/noembed/i, e.innerHTML) ? (R(e), !0) : (!G || e.firstElementChild || e.content && e.content.firstElementChild || !ze(/</g, e.textContent) || (Te(d.removed, {
        element: e.cloneNode()
      }), e.innerHTML ? e.innerHTML = Ce(e.innerHTML, /</g, "&lt;") : e.innerHTML = Ce(e.textContent, /</g, "&lt;")), V && 3 === e.nodeType && (t = e.textContent, t = Ce(t, F, " "), t = Ce(t, z, " "), e.textContent !== t && (Te(d.removed, {
        element: e.cloneNode()
    ...
    function ve(e, t, n) {
      ...
      if (W && ze(O, t)) ;else if (Z && ze(M, t)) ;else {
        if (!I[t] || B[t]) return !1;
        if (ce[t]) ;else if (ze(D, Ce(n, P, ""))) ;else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== $e(n, "data:") || !le[e]) if (Y && !ze(N, Ce(n, P, ""))) ;else if (n) return !1;
      }
      return !0;
    }
    ...
    function be(e) {
      ...
      if (o) {
        ...
        for (a = o.length; a--;) {
          ...
          if (n = Fe(t.value), r = Le(c), s.attrName = r, s.attrValue = n, s.keepAttr = !0, s.forceKeepAttr = void 0, ge("uponSanitizeAttribute", e, s), n = s.attrValue, !s.forceKeepAttr) {
            if ("name" === r && "IMG" === e.nodeName && o.id) i = o.id, o = Ee(o, []), C("id", e), C(c, e), _e(o, i) > a && e.setAttribute("id", i.value);else {
              if ("INPUT" === e.nodeName && "type" === r && "file" === n && s.keepAttr && (I[r] || !B[r])) continue;
              "id" === c && e.setAttribute(c, ""), C(c, e);
            }
            if (s.keepAttr) if (G && ze(/\/>/i, n)) C(c, e);else if (ze(/svg|math/i, e.namespaceURI) && ze(Oe("</(" + Se(ke(se), "|") + ")", "i"), n)) C(c, e);else {
              V && (n = Ce(n, F, " "), n = Ce(n, z, " "));
              var p = e.nodeName.toLowerCase();
              if (ve(p, r, n)) try {
                u ? e.setAttributeNS(u, c, n) : e.setAttribute(c, n), Ae(d.removed);
              } catch (e) {}
            }
          }
        }
    ...
    function ye(e) {
      ...
      for (ge("beforeSanitizeShadowDOM", e, null); t = n.nextNode();) {
        ge("uponSanitizeShadowNode", t, null), me(t) || (t.content instanceof p && ye(t.content), be(t));
      }
    ...
    return d.sanitize = function (e, t) {
      ...
      if ("string" != typeof (e = e || "\x3c!--\x3e") && !he(e)) {
        if ("function" != typeof e.toString) throw Me("toString is not a function");
        if ("string" != typeof (e = e.toString())) throw Me("dirty is not a string, aborting");
      }
      ...
      if (K || L(t), d.removed = [], "string" == typeof e && (ae = !1), ae) ;else if (e instanceof f) 1 === (r = (n = $("\x3c!--\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === r.nodeName ? n = r : "HTML" === r.nodeName ? n = r : n.appendChild(r);else {
        if (!J && !V && !X && ne && -1 === e.indexOf("<")) return y ? y.createHTML(e) : e;
        if (!(n = $(e))) return J ? null : k;
      }
      n && Q && R(n.firstChild);

      for (var s = fe(ae ? e : n); i = s.nextNode();) {
        3 === i.nodeType && i === a || me(i) || (i.content instanceof p && ye(i.content), be(i), a = i);
      }

      if (a = null, ae) return e;

      if (J) {
        if (ee) for (o = A.call(n.ownerDocument); n.firstChild;) {
      ...
      return V && (l = Ce(l, F, " "), l = Ce(l, z, " ")), y && ne ? y.createHTML(l) : l;
  ...
  function H(e) {
    ...
    }(), t = i ? 80 < (t = parseInt(P.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), P.style.opacity = 1, P.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(D), D = setTimeout(function (e) {
  ...
  function B(e, t, r, i) {
    ...
    var a = e._hooks[t],
        o = function o(t) {
      var e = a[t];
      if (t >= a.length) i(r);else if ("function" == typeof e) {
  ...
  function Y(e, t, r, n) {
    ...
    return i.sort(function (e, t) {
      ...
      var t = e.getAttribute("href"),
          n = r ? e.parentNode : e;
      e.title = e.innerText, 0 !== o.indexOf(t) || a ? _(n, "remove", "active") : (a = e, _(n, "add", "active"));
  ...
  function be(e, t) {
    if (t) {
      var n = A().topMargin,
          r = b("#" + t);
      r && function (e, t) {
        void 0 === t && (t = 0), fe && fe.stop(), he = !1, fe = new ce({
  ...
  var St = function St(e, t) {
    ...
    var r = {
      replace: function replace(e, t) {
        return t = (t = t.source || t).replace(gt, "$1"), n = n.replace(e, t), r;
      },
  ...
  var Ht = function () {
    ...
    return e.prototype.space = function (e) {
      ...
      if (t) {
        ...
        return r && i && (n = n.substring(1, n.length - 1)), n = Pt(n, !0), {
          type: "codespan",
          raw: t[0],
          text: n
        };
      ...
      if (i) return r = "@" === i[2] ? "mailto:" + (n = Pt(this.options.mangle ? t(i[1]) : i[1])) : n = Pt(i[1]), {
        type: "link",
        raw: i[0],
        text: n,
        href: r,
      ...
      if (n = this.rules.inline.url.exec(e)) {
        var r, i;
        if ("@" === n[2]) i = "mailto:" + (r = Pt(this.options.mangle ? t(n[0]) : n[0]));else {
          for (var a; a = n[0], n[0] = this.rules.inline._backpedal.exec(n[0])[0], a !== n[0];) {
            ;
          }
      ...
      if (i) return r = t ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : Pt(i[0]) : i[0] : Pt(this.options.smartypants ? n(i[0]) : i[0]), {
        type: "text",
        raw: i[0],
        text: r
      };
  ...
  }), Zt.gfm.url = qt(Zt.gfm.url, "i").replace("email", Zt.gfm._extended_email).getRegex(), Zt.breaks = Ut({}, Zt.gfm, {
  ...
  function Kt(e) {
    ...
    for (t = 0; t < i; t++) {
      n = e.charCodeAt(t), .5 < Math.random() && (n = "x" + n.toString(16)), r += "&#" + n + ";";
    }
  ...
  var Qt = function () {
    function n(e) {
      this.tokens = [], this.tokens.links = Object.create(null), this.options = e || Yt, this.options.tokenizer = this.options.tokenizer || new Ht(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options;
      var t = {
        block: Gt.normal,
        inline: Vt.normal
      };
    ...
    return e.rules.get = function () {
      ...
      for (void 0 === t && (t = []), void 0 === n && (n = !0), e = e.replace(/^ +$/gm, ""); e;) {
        if (r = this.tokenizer.space(e)) e = e.substring(r.raw.length), r.type && t.push(r);else if (r = this.tokenizer.code(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : ((o = t[t.length - 1]).raw += "\n" + r.raw, o.text += "\n" + r.text);else if (r = this.tokenizer.fences(e)) e = e.substring(r.raw.length), t.push(r);else if (r = this.tokenizer.heading(e)) e = e.substring(r.raw.length), t.push(r);else if (r = this.tokenizer.nptable(e)) e = e.substring(r.raw.length), t.push(r);else if (r = this.tokenizer.hr(e)) e = e.substring(r.raw.length), t.push(r);else if (r = this.tokenizer.blockquote(e)) e = e.substring(r.raw.length), r.tokens = this.blockTokens(r.text, [], n), t.push(r);else if (r = this.tokenizer.list(e)) {
      ...
      if (this.tokens.links) {
        ...
        if (0 < l.length) for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(s));) {
    ...
    return e.prototype.code = function (e, t, n) {
      ...
      if (null === (e = en(this.options.sanitize, this.options.baseUrl, e))) return n;
      var r = '<a href="' + tn(e) + '"';
    ...
    return e.prototype.slug = function (e) {
      ...
      ln = function () {
    function n(e) {
      this.options = e || on, this.options.renderer = this.options.renderer || new nn(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new rn(), this.slugger = new an();
    }
      ...
      for (n = 0; n < x; n++) {
        switch ((p = e[n]).type) {
          ...
          case "table":
            ...
            for (c += this.renderer.tablerow(l), u = "", a = p.cells.length, r = 0; r < a; r++) {
              for (l = "", o = (s = p.tokens.cells[r]).length, i = 0; i < o; i++) {
          ...
          case "list":
            for (d = p.ordered, f = p.start, h = p.loose, a = p.items.length, u = "", r = 0; r < a; r++) {
              v = (m = p.items[r]).checked, b = m.task, g = "", m.task && (y = this.renderer.checkbox(v), h ? 0 < m.tokens.length && "text" === m.tokens[0].type ? (m.tokens[0].text = y + " " + m.tokens[0].text, m.tokens[0].tokens && 0 < m.tokens[0].tokens.length && "text" === m.tokens[0].tokens[0].type && (m.tokens[0].tokens[0].text = y + " " + m.tokens[0].tokens[0].text)) : m.tokens.unshift({
                type: "text",
                text: y
              }) : g += y), g += this.parse(m.tokens, h), u += this.renderer.listitem(g, b, v);
            }
  ...
  function gn(e, n, r) {
    ...
    if ("function" == typeof n && (r = n, n = null), n = cn({}, gn.defaults, n || {}), un(n), r) {
      ...
      if (!a || a.length < 3) return _o();
      if (delete n.highlight, !i.length) return _o();
      var s = 0;
      return gn.walkTokens(i, function (n) {
        "code" === n.type && (s++, setTimeout(function () {
          a(n.text, n.lang, function (e, t) {
            if (e) return _o(e);
            null != t && t !== n.text && (n.text = t, n.escaped = !0), 0 === --s && _o();
          });
        }, 0));
      }), void (0 === s && _o());
    }
    ...
    try {
      ...
      if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", n.silent) return "<p>An error occurred:</p><pre>" + pn(e.message + "", !0) + "</pre>";
      throw e;
    }
  }
  ...
  }, gn.getDefaults = dn, gn.defaults = hn, gn.use = function (a) {
    var e = cn({}, a);
  ...
  }, gn.Parser = ln, gn.parser = ln.parse, gn.Renderer = nn, gn.TextRenderer = rn, gn.Lexer = Qt, gn.lexer = Qt.lex, gn.Tokenizer = Ht, gn.Slugger = an;
  var mn = gn.parse = gn;
  ...
  function vn(e, t) {
    ...
    return e.forEach(function (e) {
      n += '<li><a class="section-link" href="' + e.slug + '" title="' + e.title + '">' + e.title + "</a></li>", e.children && (n += vn(e.children, t));
    }), t.replace("{inner}", n);
  }
  ...
  var Tn,
    ...
    var a = function (c) {
      var u = /\blang(?:uage)?-([\w-]+)\b/i,
        ...
        util: {
          ...
          clone: function n(e, r) {
            ...
            switch (r = r || {}, z.util.type(e)) {
              ...
              case "Array":
                return t = z.util.objId(e), r[t] ? r[t] : (i = [], r[t] = i, e.forEach(function (e, t) {
                  i[t] = n(e, r);
                }), i);
        ...
        languages: {
          ...
          insertBefore: function insertBefore(n, e, t, r) {
            var i = (r = r || z.languages)[n],
                a = {};

            for (var o in i) {
              if (i.hasOwnProperty(o)) {
                if (o == e) for (var s in t) {
            ...
            var l = r[n];
            return r[n] = a, z.languages.DFS(z.languages, function (e, t) {
              t === l && e != n && (this[e] = a);
            }), a;
          },
        ...
        highlightAllUnder: function highlightAllUnder(e, t, n) {
          ...
          z.hooks.run("before-highlightall", r), r.elements = Array.prototype.slice.apply(r.container.querySelectorAll(r.selector)), z.hooks.run("before-all-elements-highlight", r);

          for (var i, a = 0; i = r.elements[a++];) {
            z.highlightElement(i, !0 === t, r.callback);
          }
        },
        highlightElement: function highlightElement(e, t, n) {
          ...
          function s(e) {
            o.highlightedCode = e, z.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, z.hooks.run("after-highlight", o), z.hooks.run("complete", o), n && n.call(o.element);
          }

          if (z.hooks.run("before-sanity-check", o), !o.code) return z.hooks.run("complete", o), void (n && n.call(o.element));
        ...
        highlight: function highlight(e, t, n) {
          ...
          return z.hooks.run("before-tokenize", r), r.tokens = z.tokenize(r.code, r.grammar), z.hooks.run("after-tokenize", r), O.stringify(z.util.encode(r.tokens), r.language);
        },
        tokenize: function tokenize(e, t) {
          ...
          var i = new a();
          return M(i, i.head, e), function e(t, n, r, i, a, o) {
            for (var s in r) {
              if (r.hasOwnProperty(s) && r[s]) {
                ...
                for (var c = 0; c < l.length; ++c) {
                  ...
                  for (var v = u.pattern || u, b = i.next, y = a; b !== n.tail && !(o && y >= o.reach); y += b.value.length, b = b.next) {
                    var k = b.value;
                    ...
                    if (!(k instanceof O)) {
                      ...
                      if (f && b != n.tail.prev) {
                        ...
                        if (A -= b.value.length, y = A, b.value instanceof O) continue;
                      ...
                      if (w) {
                        ...
                        var $ = b.prev;
                        L && ($ = M(n, $, L), y += L.length), N(n, $, x);
                        var F = new O(s, p ? z.tokenize(E, p) : E, g, E);
                        b = M(n, $, F), R && M(n, b, R), 1 < x && e(t, n, r, b.prev, y, {
                          cause: s + "," + c,
                          reach: C
                        });
                      }
      ...
      if (c.Prism = z, O.stringify = function t(e, n) {
        ...
        var i = {
          ...
          language: n
            ...
            a = e.alias;
        a && (Array.isArray(a) ? Array.prototype.push.apply(i.classes, a) : i.classes.push(a)), z.hooks.run("wrap", i);
        var o = "";
      ...
      }, !c.document) return c.addEventListener && (z.disableWorkerMessageHandler || c.addEventListener("message", function (e) {
        var t = JSON.parse(e.data),
            n = t.language,
            r = t.code,
            i = t.immediateClose;
        c.postMessage(z.highlight(r, z.languages[n], n)), i && c.close();
      }, !1)), z;
      ...
      if (e && (z.filename = e.src, e.hasAttribute("data-manual") && (z.manual = !0)), !z.manual) {
    ...
    e.exports && (e.exports = a), void 0 !== it && (it.Prism = a), a.languages.markup = {
      comment: /<!--[\s\S]*?-->/,
      prolog: /<\?[\s\S]+?\?>/,
      doctype: {
        pattern: /<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,
    ...
    }), a.languages.markup && a.languages.markup.tag.addInlined("script", "javascript"), a.languages.js = a.languages.javascript, function () {
      if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        l.hooks.add("before-highlightall", function (e) {
          ...
          if (t.matches(d)) {
            ...
            s.open("GET", r, !0), s.onreadystatechange = function () {
              4 == s.readyState && (s.status < 400 && s.responseText ? (t.setAttribute(u, "loaded"), n.textContent = s.responseText, l.highlightElement(n)) : (t.setAttribute(u, "failed"), 400 <= s.status ? n.textContent = function (e, t) {
        ...
        l.fileHighlight = function () {
          e || (console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."), e = !0), l.plugins.fileHighlight.highlight.apply(this, arguments);
        };
      }
  ...
  var Rn = {},
    ...
    })), mn), this._marked = o, this.compile = function (n) {
      var r = !0,
          e = s(function (e) {
        r = !1;
        var t = "";
  ...
  $n.prototype.compileEmbed = function (e, t) {
    ...
    if (t = i, a.include) {
      var o;
      if (Q(e) || (e = re(this.contentBase, ee(this.router.getCurrentPath()), e)), a.type && (o = Cn[a.type])) (n = o.call(this, e, t)).type = a.type;else {
        var s = "code";
        /\.(md|markdown)/.test(e) ? s = "markdown" : /\.mmd/.test(e) ? s = "mermaid" : /\.html?/.test(e) ? s = "iframe" : /\.(mp4|ogg)/.test(e) ? s = "video" : /\.mp3/.test(e) && (s = "audio"), (n = Cn[s].call(this, e, t)).type = s;
      }
  ...
  function On(e, i) {
    ...
    !function (e, o) {
      ...
      if (n) {
        ...
        }), f(p, t.links), l = l.slice(0, r).concat(t, l.slice(r + 1)), d.push({
          start: r,
          length: t.length - 1
        });
  ...
  function Pn(e) {
    e = e || "<h1>404 - Not found</h1>", this._renderTo(".markdown-section", e), this.config.loadSidebar || this._renderSidebar(), !1 === this.config.executeScript || void 0 === window.Vue || Mn() ? this.config.executeScript && Mn() : setTimeout(function (e) {
  ...
  function Dn(e) {
    var t = e.config;
    e.compiler = new $n(t, e.router), window.__current_docsify_compiler__ = e.compiler;
    var n = t.el || "#app",
        r = b("nav") || g("nav"),
        i = b(n),
        a = "",
    ...
    t.mergeNavbar && h ? o = b(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")), t.loadNavbar && k(o, r), t.themeColor && (u.head.appendChild(g("div", function (e) {
      ...
      if (!(window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)"))) {
        ...
        [].forEach.call(e, function (e) {
          if ("STYLE" === e.nodeName) U(e, n);else if ("LINK" === e.nodeName) {
            var t = e.getAttribute("href");
  ...
  Hn.prototype.getBasePath = function () {
    ...
    void 0 === e && (e = p), e();
  }, Hn.prototype.getCurrentPath = function () {}, Hn.prototype.normalize = function () {}, Hn.prototype.parse = function () {}, Hn.prototype.toURL = function (e, t, n) {
    var r = n && "#" === e[0],
        i = this.parse(ie(e));

    if (i.query = f({}, i.query, t), e = (e = i.path + K(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r) {
      var a = n.indexOf("?");
  ...
  function Wn(e) {
    ...
    }("button.sidebar-toggle", e.router), function (e) {
      null != (e = m(e)) && x(e, "click", function (e) {
        var t = e.target;
    ...
    }(".sidebar", e.router), e.config.coverpage ? h || x("scroll", W) : v.classList.add("sticky");
  }

  function Yn(t, n, r, i, a, e) {
    t = e ? t : t.replace(/\/$/, ""), (t = ee(t)) && q(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function (e) {
      return Yn(t, n, r, i, a);
    });
  }
  ...
  Jn._init = function () {
    ...
    }(e), B(e, "init"), function (t) {
      var e,
          n = t.config;
      e = "history" === (n.routerMode || "hash") && i ? new Un(n) : new qn(n), t.router = e, Zn(t), Bn = t.route, e.onchange(function (e) {
        Zn(t), t._updateRender(), Bn.path !== t.route.path ? (t.$fetch(p, t.$resetEvents.bind(t, e.source)), Bn = t.route) : t.$resetEvents(e.source);
      });
    }(e), Dn(e), Wn(e), function (t) {
  ...
  }, Jn.route = {}, (Xn = Jn)._renderTo = function (e, t, n) {
    var r = m(e);
    ...
    e && this._renderTo("nav", this.compiler.compile(e)), this.config.loadNavbar && Y(this.router, "nav");
  }, Xn._renderMain = function (r, i, a) {
    var o = this;
    if (void 0 === i && (i = {}), !r) return Pn.call(this, r);
    B(this, "beforeEach", r, function (e) {
      function t() {
        i.updatedAt && (n = Nn(n, i.updatedAt, o.config.formatUpdated)), B(o, "afterEach", n, function (e) {
          return Pn.call(o, e);
        });
      }
      ...
      o.isHTML ? (n = o.result = r, t(), a()) : On({
        ...
        n = o.compiler.compile(e), n = o.isRemoteUrl ? j.sanitize(n) : n, t(), a();
      });
    });
    ...
    if (_(m("main"), t ? "add" : "remove", "hidden"), e) {
      ...
      if (i) {
        if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");else {
          var a = i[1];
    ...
    !function (e) {
      var t = m(".app-name-link"),
          n = e.config.nameLink,
          r = e.route.path;
      if (t) if (c(e.config.nameLink)) t.setAttribute("href", n);else if ("object" == _typeof(n)) {
        var i = Object.keys(n).filter(function (e) {
    ...
    if (n) {
      var o = null,
          s = this.route.path;
      if ("string" == typeof n) "/" === s && (o = n);else if (Array.isArray(n)) o = -1 < n.indexOf(s) && "_coverpage";else {
        var l = n[s];
        o = !0 === l ? "_coverpage" : l;
      }
      var c = Boolean(o) && this.config.onlyCover;
      return o ? (o = this.router.getFile(a + o), this.coverIsHTML = /\.html$/g.test(o), q(o + K(i, ["id"]), !1, r).then(function (e) {
    ...
    "history" !== e && (t.route.query.id && be(t.route.path, t.route.query.id), "navigate" === e && n && function (e) {
      void 0 === e && (e = 0), ye.scrollTop = !0 === e ? 0 : Number(e);
    }(n)), this.config.loadNavbar && Y(this.router, "nav");
  }, window.Docsify = {
    util: Gn,
    dom: t,
    get: q,
    slugify: _n,
    version: "4.11.6"
  }, window.DocsifyCompiler = $n, window.marked = mn, window.Prism = En, e(function (e) {
    return new Vn();
  });
}();

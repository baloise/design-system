...
<div class="flex align-items-center justify-content-center gap-xx-large">
    <div class="shadow-normal flex align-items-center justify-content-center bg-green-3 radius-normal p-normal">shadow-normal</div>
    <div class="shadow-large flex align-items-center justify-content-center bg-green-3 radius-normal p-normal">shadow-large</div>
</div>
`}
/>

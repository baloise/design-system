...
<div class="flex gap-normal">
  <div class="border-top-primary p-x-small bg-green-2 flex-grow-1">Top</div>
  <div class="border-right-primary p-x-small bg-green-2 flex-grow-1">Right</div>
  <div class="border-bottom-primary p-x-small bg-green-2 flex-grow-1">Bottom</div>
  <div class="border-left-primary p-x-small bg-green-2 flex-grow-1">Left</div>
</div>
`}
/>

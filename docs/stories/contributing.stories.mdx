...
<Unstyled>
  <div className="flex gap-normal">
    ...
    <ButtonCard color="green" label="m4rc0z" description="UI Developer" link="https://github.com/m4rc0z">
      <img src="https://avatars.githubusercontent.com/u/20516386?v=4" alt="m4rc0z" />
    </ButtonCard>
    <ButtonCard
      color="green"
      label="yannickholzenkamp"
    ...
    <ButtonCard color="green" label="mmarinkov" description="UI Developer" link="https://github.com/mmarinkov">

...
- **Standalone Components:**<br/>Explicitly set standalone: true for all components to enhance modularity and maintainability.
- **[Tree-Shaking Optimization](#tree-shaking-optimization):**<br/>Removed angular-legacy to improve tree-shaking support in Angular.

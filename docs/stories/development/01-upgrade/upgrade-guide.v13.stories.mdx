...
Tree-shaking is given by Stencil and therefore to have Angular component modules
...
Therefore please import them before the Baloise styles also check out our [documentation](https://design.baloise.dev/?path=/docs/components-table--basic#aggrid)

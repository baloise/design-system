...
<Code language="bash" noPreview code={`npm install -E @ngneat/transloco`} />
...
<Code language="bash" noPreview code={`npm install -D -E @baloise/design-system-cli`} />

Install the library using Angular CLI:

```bash
ng add @baloise/design-system-cli
# On an nx workspace
...
Use `@baloise/design-system-styles/sass/mixins` to gain access to SASS mixins, such as breakpoints.
...
However, if the application requires all styles regardless of payload size, simply import the stylesheet `@baloise/design-system-styles/sass/baloise-design-system`
...
```
npm add -E @baloise/design-system-components
```
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="node_modules/@baloise/design-system-styles/css/baloise-design-system.css" />
    <script
      type="module"
...
Like => `https://cdn.jsdelivr.net/npm/@baloise/design-system-styles@16/css/baloise-design-system.css`
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@baloise/design-system-styles/css/baloise-design-system.css" />
<script
  type="module"
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@baloise/design-system-styles/css/baloise-design-system.css"
    />
    <script
      type="module"
      src="https://cdn.jsdelivr.net/npm/@baloise/design-system-components/dist/design-system-components/design-system-components.esm.js"
...
```
npm add -E @baloise/design-system-components-vue
```

...
<Banner label="Controller" section="Contributing" />
...
To register the controller globally add it to the `src/controllers.ts` file.
...
To use your controller in your component documentation expose it to the window object.
...
- [Toast](?path=/docs/components-feedback-toast--documentation)
- [Snackbar](?path=/docs/components-feedback-snackbar--documentation)
- [Modal](?path=/docs/components-feedback-modal--documentation)

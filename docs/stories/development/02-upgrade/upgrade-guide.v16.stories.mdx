...
This enhancement extends functionality, particularly in responsive design and pseudo-states. Moreover, the renaming (or removing of prefixes like `is-*` or `has-*`) of
the classes should improve the readability too.
...
@import '@baloise/design-system-css/css/interaction';
...
@import '@baloise/design-system-css/css/sizing';

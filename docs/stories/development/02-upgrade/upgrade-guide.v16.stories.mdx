...
| CSS (DEPRECATED)                    | Stypes (NEW)              |
| ----------------------------------- | ------------------------- |
| \`has-radius-none\`                 | \`radius-none\`           |
| \`has-radius-top-none\`             | \`radius-top-none\`       |
| \`has-radius-top-left-none\`        | removed                   |
| \`has-radius-top-right-none\`       | removed                   |
| \`has-radius-bottom-none\`          | \`radius-bottom-none\`    |
| \`has-radius-bottom-left-none\`     | removed                   |
| \`has-radius-bottom-right-none\`    | removed                   |
| \`has-radius-normal\`               | \`radius-normal\`         |
| \`has-radius-top-normal\`           | \`radius-top-normal\`     |
| \`has-radius-top-left-normal\`      | removed                   |
| \`has-radius-top-right-normal\`     | removed                   |
| \`has-radius-bottom-normal\`        | \`radius-bottom-normal\`  |
| \`has-radius-bottom-left-normal\`   | removed                   |
| \`has-radius-bottom-right-normal\`  | removed                   |
| \`has-radius-large\`                | \`radius-large\`          |
| \`has-radius-top-large\`            | \`radius-top-large\`      |
| \`has-radius-top-left-large\`       | removed                   |
| \`has-radius-top-right-large\`      | removed                   |
| \`has-radius-bottom-large\`         | \`radius-bottom-large\`   |
| \`has-radius-bottom-left-large\`    | removed                   |
| \`has-radius-bottom-right-large\`   | removed                   |
| \`has-radius-rounded\`              | \`radius-rounded\`        |
| \`has-radius-top-rounded\`          | \`radius-top-rounded\`    |
| \`has-radius-top-left-rounded\`     | removed                   |
| \`has-radius-top-right-rounded\`    | removed                   |
| \`has-radius-bottom-rounded\`       | \`radius-bottom-rounded\` |
| \`has-radius-bottom-left-rounded\`  | removed                   |
| \`has-radius-bottom-right-rounded\` | removed                   |
`}
</Markdown>

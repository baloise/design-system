...
<Banner label="Updating to v13" section="Development/Upgrade Guides" color="red" />
...
We recommend to use the native event click instead of our balClick.
...
Icon size `large` changed form `3.125rem` (50px) to `2.5rem` (40px). We only support sizes which are
dividable by 8.

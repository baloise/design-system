...
For a complete list of available skills and how to use them, see [SKILLS.md](SKILLS.md). How to test the published consumer installer (`npx @helvetia/ds-skills add`) is in [packages/ds-skills/CONTEXT.md](../packages/ds-skills/CONTEXT.md#testing).

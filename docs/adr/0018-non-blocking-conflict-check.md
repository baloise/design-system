# 18. Conflict check comments, it doesn't block the merge
...
a real Conflict (per [packages/tokens/CONTEXT.md](../../packages/tokens/CONTEXT.md)'s
...
see [figma-token-sync-plugin-plan.md §8](../plans/figma-token-sync-plugin-plan.md#8-future-extensions).

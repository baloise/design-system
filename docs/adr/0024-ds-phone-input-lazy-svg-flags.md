# 24. ds-phone-input loads per-country flag SVGs lazily instead of emoji or a sprite sheet
...
Superseded by [ADR-0033](0033-ds-phone-input-bundled-svg-flags.md)

## Context

`ds-phone-input` must show a flag per country in the picker and next to the

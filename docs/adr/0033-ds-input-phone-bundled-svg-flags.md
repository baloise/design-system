...
Accepted. Supersedes [ADR-0024](0024-ds-input-phone-lazy-svg-flags.md).
...
`Flags` namespace export. `ds-input-phone`'s `flag.ts` becomes a plain lookup (`getFlagSvg(code)`)

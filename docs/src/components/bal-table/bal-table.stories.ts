...
import { StoryFactory, props, withComponentControls, withContent, withDefaultContent, withRender } from '../../utils'
...
// import angularPkg from '../../../../docs.old/public/assets/code/angular/package.json'

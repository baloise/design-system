...
| \`url\`       | String                   | The URL of the logo image to be placed instead of the default one.                  |
| \`svg\`       | String                   | The SVG content to be used as the logo image instead of the default one.                  |

...
| **closeOnSelect** | Closes the datepicker dropdown after selection                                                                                                                                                                                                                                                                                                                          | <code>boolean</code>                                           | <code>true</code>         |
...
| **defaultDate**   | The date to defines where the datepicker popup starts. The prop accepts ISO 8601 date strings (YYYY-MM-DD).                                                                                                                                                                                                                                                             | <code>null , string , undefined</code>                         |                           |
...
| **maxYearProp**   | Latest year available for selection                                                                                                                                                                                                                                                                                                                                     | <code>number , undefined</code>                                | <code>undefined</code>    |
...
| **minYearProp**   | Earliest year available for selection                                                                                                                                                                                                                                                                                                                                   | <code>number , undefined</code>                                | <code>undefined</code>    |
...
| **triggerIcon**   | If `true` the datepicker only open on click of the icon                                                                                                                                                                                                                                                                                                                 | <code>boolean</code>                                           | <code>false</code>        |

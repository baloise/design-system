...
<StoryHeading of={DropDownStories.Filter}></StoryHeading>

This style can be used to implement filter dropdown controls for list or tables.

<Canvas of={DropDownStories.Filter} className="has-visible-overflow" />

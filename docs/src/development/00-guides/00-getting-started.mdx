...
import { BalLayoutBundle, BalHeading, Button } from '@baloise/ds-angular'
...
import { BalButton, BalHeading, LayoutBundle, provideBaloiseDesignSystem } from '@baloise/ds-angular'

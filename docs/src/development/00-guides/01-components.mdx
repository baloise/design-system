...
<bal-button color="secondary">My secondary button</bal-button>
```
...
<bal-button [color]="buttonColor">My secondary button</bal-button>
```
...
```html
<bal-button color="secondary">My secondary button</bal-button>
<bal-button id="my-secondary-button">My secondary button</bal-button>
...
```html
<bal-input placeholder="Tell us your name" [value]="myName" (dsInput)="updateName($event.detail)"></bal-input>

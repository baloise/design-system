...
import { Banner, Breakpoints, Code, Footer, Lead, LinkCard, LinkCards, ScssSource } from '../../../.storybook/blocks'
...
<Banner label="Breakpoints" section="CSS Utilities" color="red" />
...
<ScssSource code={`@use '@baloise/ds-css/dist/scss/mixins' as *;
...
<ScssSource code={`.my-element {
  color: lime;
}

@include from(var(--ds-breakpoint-tablet)) {
${' '}${' '}// add your custom styles here
${' '}${' '}.my-element {
${' '}${' '}${' '}${' '}color: blue;
${' '}${' '}}

...
<InfoQuote>
  When writing component code, follow the{' '}
  <a href="/?path=/docs/contributing-component-style-guide--documentation">Component Style Guide</a> to keep naming,
  structure, and patterns consistent across all components.
</InfoQuote>

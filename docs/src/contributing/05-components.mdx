...
<InfoQuote>
  All components must follow the{' '}
  <a href="/?path=/docs/contributing-component-style-guide--documentation">Component Style Guide</a>. It covers naming
  conventions, prop rules, CSS patterns, and more — read it before writing any component code.
</InfoQuote>
...
| File                    | Description                                                  |
| ----------------------- | ------------------------------------------------------------ |
| ds-badge.tsx           | Stencil component which will be compiled into Web-Component. |
| ds-badge.scss          | Custom component stylesheet, which is lazy loaded.           |
| ds-badge.interfaces.ts | Types for properties and events of the component.            |
| ds-badge.vars.scss     | CSS variables which can be used for theming.                 |
  `}
</Markdown>
...
| ---------------------- | ----------------------------------------- | ------------------------- |
| ds-badge.a11y.html    | Example html file for accessibility test. | e2e/cypress/e2e/a11y      |
| ds-badge.theming.html | Example theming file.                     | e2e/cypress/e2e/visual    |
| ds-badge.visual.html  | Example html file for visual test.        | e2e/cypress/e2e/visual    |
  `}
</Markdown>
...
const meta: Meta<Args> = {
  ...
  argTypes: {
    ...withContent(),
    ...withComponentControls({ tag: 'ds-badge' }),
},

...
<Lead>
  The Helvetia Design System is divided into multiple NPM packages. Development for all packages are happening inside one
...
The Helvetia Design System is divided into multiple NPM packages.

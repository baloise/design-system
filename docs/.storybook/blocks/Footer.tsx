...
export const Footer = ({ children }) => {
  return (
    <section className="sb-unstyled mt-2xl">
      {children}
      <section className="mt-xl pt-normal">
        <div className="bg-grey-2 p-medium radius">
        ...
        <p className="flex-1 is-bold mt-large">© 2026 Helvetia Baloise Holding AG</p>
        <div className="flex gap-small pt-small">
          <a
            className="link"

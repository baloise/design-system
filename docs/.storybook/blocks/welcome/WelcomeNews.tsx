...
export const WelcomeNews = ({ children }) => {
  return (
    <div className="my-welcome-content mt-xx-large mb-large sb-unstyled">
        ...
        <div className="col">
          <bal-card fullheight flat class="p-none" color="purple-2">
            <bal-card-content>
              ...
              <bal-text space="top">
                Due to Angular performance optimizations we need to change the module architecture. Moreover, steps &
                tabs component are divided to be more maintainable. Types of properties and events have been improved
                from the ground.
              </bal-text>
              <a

...
Follow the migration guide [Migration from 8.x to 9.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-8-x-to-9-x--page)
...
- **tabs:** `rounded` prop is removed use `interface` `tabs-sub`
  - Follow the migration guide [Migration from 7.x to 8.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-7-x-to-8-x--page)
...
- The unsupported browsers has been moved to [@baloise/web-app-unsupported-browsers](https://github.com/baloise/web-app-utils/tree/master/packages/unsupported-browsers).
  - Follow the migration guide [Migration from 6.x to 7.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-6-x-to-7-x--page)
...
- Added and improved the css helper classes.
  - Follow the migration guide [Migration from 5.x to 6.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-5-x-to-6-x--page)
...
- The component `bal-app` lost his props, due better integration for our proxy libraries.
  - Follow the migration guide [Migration from 4.x to 5.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-4-x-to-5-x--page)
...
- The breakpoints and spacing helpers are adjusted to new guidlines and duplicated/old css class are removed.
  - Follow the migration guide [Migration from 3.x to 4.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-3-x-to-4-x--page)
...
- `has-sticky-footer` has to be set explicit to the `ba-app` component.
  - Follow the migration guide [Migration from 2.x to 3.x](https://baloise-design-v10.vercel.app/?path=/story/migration-migration-from-2-x-to-3-x--page)
...
- Moved utils, filters/pipes and validators to [web-app-utils](https://github.com/baloise/web-app-utils) packages.
  - Follow the migration guide [Migration from 1.x to 2.x](https://baloise-design-v10.vercel.app/components/migration/migration-from-1.x.html)
...
- new font package `@baloise/design-system-fonts`
  - follow the new style [instalation guide](https://baloise-design-v10.vercel.app/components/getting-started/vue/styles.html)

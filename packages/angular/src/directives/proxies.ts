...
@ProxyCmp({
  inputs: ['balTabindex', 'closeOnSelect', 'debounce', 'disabled', 'expanded', 'filter', 'inverted', 'locale', 'max', 'maxYearProp', 'min', 'minYearProp', 'name', 'placeholder', 'readonly', 'required', 'triggerIcon', 'value'],

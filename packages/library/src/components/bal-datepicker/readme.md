...
| `maxDate`       | --                | Latest date available for selection                                                                                                                                     | `Date \| undefined`            | `undefined`    |
| `maxYearProp`   | `max-year`        | Latest year available for selection                                                                                                                                     | `number \| undefined`          | `undefined`    |
| `minDate`       | --                | Earliest date available for selection                                                                                                                                   | `Date \| undefined`            | `undefined`    |
...
| `value`         | --                | Selected date. Could also be passed as a string, which gets transformed to js date object.                                                                              | `Date \| undefined`            | `undefined`    |

...
export class FieldControl {
  ...
  get buildIconLeftTemplate() {
    if (this.iconLeft) {
      return <bal-icon name={this.iconLeft} type="info" class="is-left" inverted={this.inverted} />
    }
    return ''
  }
  ...
  get buildIconRightTemplate() {
    if (this.iconRight) {
      return <bal-icon name={this.iconRight} type="info" class="is-right" inverted={this.inverted} />
    }
    return ''
  }

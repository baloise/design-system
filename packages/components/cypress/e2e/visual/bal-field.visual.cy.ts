describe('bal-field', () => {
  ...
  it('basic component', () => {
    ...
    cy.getByTestId('label-long').compareSnapshot('label-long-desktop', 0.0)
    ...
    cy.getByTestId('label-long').compareSnapshot('label-long-tablet', 0.0)
    ...
    cy.getByTestId('label-long').compareSnapshot('label-long-mobile', 0.0)
  })
})

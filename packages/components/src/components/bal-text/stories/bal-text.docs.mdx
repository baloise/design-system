...
<bal-doc-banner id="story--components-text--basic" status="rebranded,sass">Text</bal-doc-banner>

<bal-doc-tabs>
  <a href="#story--components-text--basic">Overview</a>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="text"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

...
<bal-doc-banner id="story--components-tag--basic" status="rebranded,sass,visual,a11y">Tag</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="tag"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

...
<bal-doc-banner id="story--components-form-field--basic" status="rebranded,sass">Field</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="field,input"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

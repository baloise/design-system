...
<bal-doc-banner id="story--components-form-time-input--basic">Time Input (WIP)</bal-doc-banner>

<bal-doc-tabs>
  <a href="#story--components-form-time-input--basic">Overview</a>
...
<bal-doc-lead>
  <b>Time Input</b> allows the user to enter a valid time.
</bal-doc-lead>
...
<bal-doc-app>
  <bal-button-group class="mb-6" position="center">
    <a class="button is-info is-outlined" href="?path=/story/components-form-time-input--basic">

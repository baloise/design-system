...
<bal-doc-banner id="story--components-form-checkbox--basic" status="rebranded,sass">Checkbox</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="checkbox"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

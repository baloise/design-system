...
<bal-doc-banner id="story--components-form-fileupload--basic" status="rebranded,sass">File Upload</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="field,file-upload"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

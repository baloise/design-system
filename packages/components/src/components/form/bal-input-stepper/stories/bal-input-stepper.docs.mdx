...
<bal-doc-banner id="story--components-form-input-stepper--basic" status="rebranded,sass">Input Stepper</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="input-stepper"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

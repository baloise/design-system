...
<bal-doc-banner id="story--components-form-number-input--basic" status="rebranded,sass">Number Input</bal-doc-banner>

<bal-doc-tabs>
  <a href="#story--components-form-number-input--basic">Overview</a>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="number-input"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

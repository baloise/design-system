...
<bal-doc-banner id="story--components-form-input-group--basic" status="rebranded">Input Group</bal-doc-banner>

<bal-doc-tabs>
  <a href="#story--components-form-input-group--basic">Overview</a>

...
export const RadioBoxes = args => ({
  ...
  <bal-radio-group v-bind="args" v-model="value">
    <div class="columns" style="max-width: 400px">
      <div class="column">
        <div @click="checkA()" :class="value === '1' ? 'has-background-light-blue':''" class="clickable is-flex px-normal py-small is-flex-direction-column is-justify-content-center is-align-items-center has-border-primary has-radius">
      ...
      <div class="column">
        <div @click="checkB()" :class="value === '2' ? 'has-background-light-blue':''" class="clickable is-flex px-normal py-small is-flex-direction-column is-justify-content-center is-align-items-center has-border-primary has-radius">

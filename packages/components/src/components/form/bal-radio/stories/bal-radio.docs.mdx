...
<bal-doc-banner id="story--components-form-radio--basic" status="rebranded,sass">Radio</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="radio"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

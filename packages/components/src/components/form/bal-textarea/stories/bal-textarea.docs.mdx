...
<bal-doc-banner id="story--components-form-textarea--basic" status="rebranded,sass">Textarea</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="textarea"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

...
<bal-doc-banner id="story--components-form-slider--basic" status="rebranded,sass">Input Slider</bal-doc-banner>

<bal-doc-tabs>
  <a href="#story--components-form-slider--basic">Overview</a>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="input-slider"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>
...
<Canvas>
  <Story id="components-form-slider--field-control" />
</Canvas>

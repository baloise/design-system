...
<bal-doc-banner id="story--components-form-slider--basic">Slider</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-6" position="center">
    <a class="button is-info is-outlined" href="?path=/story/components-form-slider--basic">

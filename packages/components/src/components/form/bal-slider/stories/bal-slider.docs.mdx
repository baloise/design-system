...
<bal-doc-banner id="story--components-form-slider--basic" status="">Slider</bal-doc-banner>
...
<bal-doc-lead>
  <b>Slider</b> component lets users select from a range of values by moving the slider thumb.
</bal-doc-lead>

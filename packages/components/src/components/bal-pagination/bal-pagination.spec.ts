...
describe('bal-pagination-util testing:', () => {
  describe('generate pagination conrols', () => {
    ...
    test('should generate first page controls', () => {
    ...
    test('should generate controls with the range 1', () => {
      const result = generatePaginationControl(5, 10, 1)
      expect(result).toHaveLength(7)
      expect(result[0]).toStrictEqual(pageOne)
      expect(result[1]).toStrictEqual(dots)
    ...
    test('should generate controls with the range 2', () => {
    ...
    test.skip('should generate controls with the range 2 active page 7', () => {
      ...
      expect(result[4]).toStrictEqual({ ...pageSeven, active: true })
      expect(result[5]).toStrictEqual(pageEight)

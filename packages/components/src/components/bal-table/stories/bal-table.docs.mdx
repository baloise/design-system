...
<bal-doc-tabs>
  <a href="#story--components-table--basic">Overview</a>
...
```bash
npm install --save @baloise/design-system-next-components-table ag-grid-community
```

Next we need to link the stylesheet into our global scss file.

```scss
@import 'node_modules/@baloise/design-system-next-components-table/scss';
```
...
```typescript
import { BalTableButtonRenderer } from '@baloise/design-system-next-components-table'
...
```typescript
import { BalTableTagRenderer } from '@baloise/design-system-next-components-table'
...
```typescript
import { BalTableTextRenderer } from '@baloise/design-system-next-components-table'

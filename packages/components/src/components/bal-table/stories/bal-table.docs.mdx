...
<bal-doc-github link="D:/Baloise/projects/baloise-incubator/design-system/packages/components/src/components/bal-table/stories/bal-table.docs.mdx"></bal-doc-github>

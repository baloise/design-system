...
export const Basic = args => ({
  ...
  <bal-accordion-details>
    <p class="py-medium">{{ args.content }}</p>
  </bal-accordion-details>
</bal-accordion>`,
})
Basic.args = {
...
export const ButtonAccordion = args => ({
  components: { ...component.components },
  setup: () => ({ args }),
  template: `<bal-card>
...
ButtonAccordion.parameters = { ...component.sourceCode(ButtonAccordion) }

export const OldVersion = args => ({
  components: { ...component.components },
  setup: () => ({ args }),
  template: `<bal-accordion open-icon="edit" open-label="Bearbeiten" close-label="Schliessen" close-icon="close">
  <p class="py-medium">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
  </bal-accordion>`,
})
OldVersion.args = {
  content:
...
OldVersion.parameters = { ...component.sourceCode(OldVersion) }

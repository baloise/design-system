...
<ol>
  <li><b>Meta Tabs:</b> Provide a high-level overview of the application's key sections and feature action buttons for quick access to common actions.</li>
  <li><b>Main Tabs:</b> Offer a detailed navigation structure, allowing users to explore specific sections and pages within the application.</li>
  <li><b>Flyout:</b> Providing additional navigation options for a more comprehensive user experience.</li>
  <li><b>Action buttons:</b> Represent action buttons within the Meta Tabs section of the Navigation component</li>
  <li><b>Section links:</b> Used to define the section link items within the main part of the Navigation component.</li>
  <li><b>Service links:</b> Used to define the service section link items within the main part of the Navigation component.</li>
</ol>

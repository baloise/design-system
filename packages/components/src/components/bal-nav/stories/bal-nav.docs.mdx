...
```bash
.
├── logo: BalNavLogoLink                               # placeholder
├── buttons: BalNavMetaButtons                         # placeholder
├── options: BalNavOptions                             # placeholder
  ├── BalNavMetaLinkItem[]                             # placeholder
    ├── overviewLink: BalNavLinkItem                   # placeholder
    ├── mainLinkItems: BalNavMenuLinkItem[]            # placeholder
      |── overviewLink: BalNavLinkItem                 # placeholder
      |── sectionLinkItems: BalNavSectionLinkItem[]    # placeholder
        |── linkItems: BalNavLinkItem[]                # placeholder
      |── serviceLinkItems: BalNavServiceLinkItem[]    # placeholder
        |── color:                                     # placeholder
        |── linkItems: BalNavLinkItem[]                # placeholder
```
...
#### buttons (Type: List of BalNavMetaButton)
...
#### overviewLink (Type: BalNavLinkItem)
...
#### mainLinkItems (Type: BalNavMenuLinkItem[])
...
#### sectionLinkItems (Type: BalNavSectionLinkItem[])
...
#### serviceLinkItems (Type: BalNavServiceLinkItem[])

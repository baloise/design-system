...
import readmeItem from '../bal-slider-item/readme.md'

<bal-doc-banner id="story--components-slider--basic" status="rebranded,sass">Slider</bal-doc-banner>
...
<bal-doc-lead>Simple slider component for product sliding.</bal-doc-lead>
...
<bal-doc-app>
  <bal-button-group class="mb-6" position="center">
    <a class="button is-primary" href="?path=/story/components-slider--basic">

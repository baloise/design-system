...
> **TIP**
>
> The bal-icon is based on the [icons foundation](?path=/docs/foundation-icons-code--page) so check this out for adding more icons to your set.
...
<a class="button is-info" href="?path=/docs/foundation-icons-code--page">

...
<bal-doc-lead>
  ...
  <a href="https://github.com/baloise/design-system/tree/main/packages/icons/svg">folder</a>. Then the build script will
  automatically optimize the svg and provide it to the component. It is important that the svg icons are made with fill
  elements instead of strokes.
</bal-doc-lead>

...
import { Basic } from './bal-close.stories'

<bal-doc-banner id="story--components-close--basic">Close</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz framework="angular" template={Basic.parameters.docs.source.code} modules="close"></bal-doc-stackblitz>
    <bal-doc-stackblitz framework="html" template={Basic.parameters.docs.source.code} modules="close"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

...
import readmeItem from '../bal-product-slider-item/readme.md'

<bal-doc-banner id="story--components-product-slider--basic" status="rebranded,sass">Product Slider</bal-doc-banner>
...
<span id="story--components-product-slider--with-tabs" style={{ opacity: 0 }}></span>

### With Tabs

Use "bal-tabs" component for switching between categories of products.

<Canvas>
  <Story id="components-product-slider--with-tabs" />
</Canvas>

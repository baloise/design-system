...
| `color`      | `color`       | Defines the color of the card.                                                                 | `"" \| "$pink-light" \| "azul" \| "blue" \| "danger" \| "gray" \| "green" \| "green-light" \| "orange" \| "pink" \| "primary" \| "success" \| "violett" \| "violett-light" \| "warning" \| "yellow"` | `''`    |

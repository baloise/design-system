...
| `color`      | `color`       | Defines the color of the card.                                                                 | `"" \| "azul" \| "blue" \| "danger" \| "gray" \| "green" \| "green-light" \| "orange" \| "pink" \| "pink-light" \| "primary" \| "success" \| "violett" \| "violett-light" \| "warning" \| "yellow"` | `''`    |

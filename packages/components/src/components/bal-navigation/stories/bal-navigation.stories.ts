...
export const Basic = args => ({
  ...
  <bal-navigation v-bind="args" meta-value="meta-1">
    <bal-navigation-levels> <!-- hidden in the dom but can be grabbed by the mutation observer -->
      <bal-navigation-level-meta value="meta-1" label="Privatkunden" link="/?path=/story/components-navigation--basic"
        linkLabel="Zur Privatkundenübersicht">
        <bal-navigation-level-main value="meta-1-main-1" label="Versichern" link="http://"
          linkLabel="Alle Versicherungslösungen">
          <bal-navigation-level-block label="Wohnen & Recht" link="http://">
            <bal-navigation-level-block-item label="Haushaltsversicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Haftpflicht" link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Einzel Gegenstände vom Handy bis zum e-Bike"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item
              label="Cyber-Versicherung (Kreditkartenmissbrauch, Cyber-Mobbing, Schadsoftware)"
              link="http://"></bal-navigation-level-block-item>
          ...
          <bal-navigation-level-block label="Wohneigentum" link="http://">
            <bal-navigation-level-block-item label="Gebäudeversicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Erdbebenversicherung"
              link="http://"></bal-navigation-level-block-item>
          ...
          <bal-navigation-level-block label="Fahrzeuge & Reisen" link="http://">
            ...
            <bal-navigation-level-block-item label="Fahrzeug Innenraum (auch Wohnwagen)"
              link="http://"></bal-navigation-level-block-item>
          ...
          <bal-navigation-level-block label="Personen (Unfall, Krankheit, Tod)" link="http://">
            <bal-navigation-level-block-item label="Unfallversicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Todesfallrisikoversicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Krankentaggeldversicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Lebensversicherung & Life Coach"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Erwerbsunfähigkeits-versicherung"
              link="http://"></bal-navigation-level-block-item>
            <bal-navigation-level-block-item label="Unfallversicherung für Hausangestellte"
              link="http://"></bal-navigation-level-block-item>
          </bal-navigation-level-block>
        ...
        <bal-navigation-level-main value="meta-1-main-2" label="Sparen, Zahlen & Finanzieren" link="http://"
          linkLabel="Go to Main 1">
        ...
        <bal-navigation-level-main value="meta-1-main-3" label="Anlegen & Vorsorgen" link="http://"
          linkLabel="Go to Main 1">
          <bal-navigation-level-block label="Meta 1 Main 3 Block 1" link="http://">
            <bal-navigation-level-block-item label="Item 1" link="http://"></bal-navigation-level-block-item>
          </bal-navigation-level-block>
        </bal-navigation-level-main>
        <bal-navigation-level-main value="meta-1-main-4" label="Kontakt & Services" link="http://"
          linkLabel="Go to Main 1">
      ...
      <bal-navigation-level-meta value="meta-2" label="Unternehmen" link="/?path=/story/components-navigation--basic"
        linkLabel="Go to Meta 2 Overview">
      ...
      <bal-navigation-level-meta value="meta-3" label="Institutionelle Anleger"
        link="/?path=/story/components-navigation--basic" linkLabel="Go to Meta 2 Overview">
      ...
      <bal-navigation-level-meta value="meta-4" label="Über uns" link="/?path=/story/components-navigation--basic"
        linkLabel="Go to Meta 2 Overview">
    ...
    <bal-button-group slot="meta-actions">
      <bal-navigation-popover backdrop={true} icon="call" size="small" inactive-color="light" active-color="primary"
        inverted={true} square={true} arrow={true} content-radius="large" position="bottom" content-width=440
        content-min-width=440 offsetY=13 heading="24h Kundenservice">
      ...
      <bal-navigation-popover backdrop={true} icon="web" size="small" inactive-color="light" active-color="primary"
        inverted={true} square={true} arrow={true} content-radius="large" position="bottom" content-width=440
        content-min-width=440 offsetY=13 heading="Sprache wählen">
        <ul class="is-flex is-flex-direction-column" style="gap: 1rem">
          <li class="p-normal"
            style="background-color:lightgrey;padding:.75rem;color:#000D6E;text-align:center;border-radius:4px">English
          </li>
          <li class="p-normal"
            style="background-color:lightgrey;padding:.75rem;color:#000D6E;text-align:center;border-radius:4px">German
          </li>
          <li class="p-normal"
            style="background-color:lightgrey;padding:.75rem;color:#000D6E;text-align:center;border-radius:4px">French
          </li>
        </ul>
      </bal-navigation-popover>
      ...
      <bal-navigation-popover backdrop={true} icon="account" size="small" inactive-color="light" active-color="primary"
        inverted={true} arrow={true} content-radius="large" position="bottom" content-width=440 content-min-width=440
        offsetY=13 heading="Baloise Login" label="login">
        <ul class="is-flex is-flex-direction-column" style="gap: 1rem">
          <li class="p-normal"
            style="background-color:lightgrey;padding:.75rem;color:#000D6E;text-align:center;border-radius:4px">Login
          </li>
        </ul>
      </bal-navigation-popover>
    </bal-button-group>
    <div slot="meta-actions-mobile">
      <bal-navigation-popover backdrop={true} position="bottom" square={true} icon="search" bal-popover-trigger
        content-radius="none" content-no-shadow={true} content-expanded={true} active-color="primary"
        inactive-color="light" heading="Suche" offsetY=8 mobile-top={true}>
        <div>
          Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum
          Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum
          Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum
    ...
    <div slot="meta-mobile-foot">
      <bal-navigation-popover backdrop={true} position="top" square={true} icon="call" bal-popover-trigger
        content-radius="large-bottom-none" content-no-shadow={true} content-expanded={true} active-color="primary"
        inactive-color="white" offsetY=7 heading="24h Kundenservice">
        <bal-button expanded={true} href="tel://00800 24 800 800" icon="call">00800 24 800 800</bal-button>
      </bal-navigation-popover>

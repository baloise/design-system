...
export const Basic = args => ({
  ...
  <bal-stage-body>
    ...
    <bal-heading class="mb-x-small" space="none">{{ args.content }}</bal-heading>
    </bal-stage-body>
</bal-stage>`,
})
Basic.args = {
...
export const StageWithImage = args => ({
  ...
  <bal-stage-body>
    <bal-stage-back-link href="#" class="mb-medium" :shadow="args.shadow" :inverted="args.inverted">Zurück</bal-stage-back-link>
    <bal-heading class="mb-xx-large" space="none" :shadow="args.shadow" :inverted="args.inverted">{{ args.content }}</bal-heading>

...
<span id="story--01-components-form-datepicker--basic" style={{ opacity: 0 }}></span>
...
<Canvas className="bal-app has-visible-overflow">
  <Story id="01-components-form-datepicker--basic" />
</Canvas>
...
<Canvas className="bal-app has-visible-overflow">
  <Story id="01-components-form-datepicker--manual-input" />
</Canvas>

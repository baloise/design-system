...
<bal-doc-banner id="story--components-feedback-notification--basic" >Notification</bal-doc-banner>
...
<Canvas withSource="open" className="has-visible-overflow">
  <Story id="components-feedback-notification--basic" />
</Canvas>

<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    <a class="button is-primary" href="?path=/story/components-feedback-notification--basic">

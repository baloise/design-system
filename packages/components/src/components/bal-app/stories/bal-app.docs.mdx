...
<bal-doc-tabs>
  <a href="#story--components-app--basic">Overview</a>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="app,navbar,button,footer,card"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

...
<bal-doc-banner id="story--components-logo--basic" status="rebranded,sass">Logo</bal-doc-banner>
...
<bal-doc-app>
  <bal-button-group class="mb-large" position="center">
    ...
    <bal-doc-stackblitz template={Basic.parameters.docs.source.code} modules="logo"></bal-doc-stackblitz>
  </bal-button-group>
</bal-doc-app>

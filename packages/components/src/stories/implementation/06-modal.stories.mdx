...
import { BalModalService } from '@baloise/design-system-next-components-angular'
...
```html
<script setup lang="ts">
  import { balModalController, BalButton } from '@baloise/design-system-next-components-vue'

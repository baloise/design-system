...
```typescript
import { BalCoreModule, BalHeadingModule } from '@baloise/design-system-next-components-angular';
...
<script setup lang="ts">
  import { BalApp, BalHeading } from '@baloise/design-system-next-components-vue'
</script>
...
import { BalApp, BalHeading } from "@baloise/design-system-next-components-react";

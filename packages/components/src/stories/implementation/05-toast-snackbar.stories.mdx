...
<Meta
  title="Implementation/Toast & Snackbar"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-banner id="overview" subtitle="Implementation">Toast & Snackbar</bal-doc-banner>
...
import { BalToastService } from '@baloise/design-system-next-components-angular'
...
<script setup lang="ts">
  import { BalApp, BalButton } from '@baloise/design-system-next-components-vue'
...
import { BalButton } from '@baloise/design-system-next-components-react'
import { balToastController } from '@baloise/design-system-next-components'
...
<bal-doc-github link="/stories/implementation/05-toast-snackbar.stories.mdx"></bal-doc-github>

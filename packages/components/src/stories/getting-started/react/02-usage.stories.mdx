...
After adding the `BaloiseDesignSystem` the components are registered and can be used directly in your custom react components.
...
::: tip
More filters are listed here [filters](/components/tooling/filters.html)
:::
...
<bal-doc-github link="/stories/getting-started/react/02-usage.stories.mdx"></bal-doc-github>

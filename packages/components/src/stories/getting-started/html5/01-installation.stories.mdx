...
```bash
npm install @baloise/design-system-next-components --save
```
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="node_modules/@baloise/design-system-next-components/dist/design-system-next-components/design-system-next-components.css"
    />

    <script
      type="module"
      src="node_modules/@baloise/design-system-next-components/dist/design-system-next-components/design-system-next-components.esm.js"
    ></script>
    <script
      nomodule
      src="node_modules/@baloise/design-system-next-components/dist/design-system-next-components/design-system-next-components.js"
    ></script>
  </head>
  <body class="bal-body">
    <bal-app>
...
"scripts": {
  ...
  "copy:fonts": "copyfiles --flat node_modules/@baloise/design-system-next-fonts/lib/* assets/fonts"
}
```
...
<!--
TODO: Only works when we are public
...
> Like => `https://cdn.jsdelivr.net/npm/@baloise/design-system-next-fonts@10/lib/fonts.cdn.css`
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@baloise/design-system-next-components/dist/design-system-components/design-system-components.css"
/>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@baloise/design-system-next-fonts/lib/fonts.cdn.css" />
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@baloise/design-system-next-components/dist/design-system-components/design-system-components.esm.js"
></script>
<script
  nomodule
  src="https://cdn.jsdelivr.net/npm/@baloise/design-system-next-components/dist/design-system-components/design-system-components.js"
></script>
``` -->

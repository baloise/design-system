...
The can be used in the component typescript file as well.
...
<bal-doc-github link="/stories/getting-started/angular/03-04-usage-pipes.stories.mdx"></bal-doc-github>

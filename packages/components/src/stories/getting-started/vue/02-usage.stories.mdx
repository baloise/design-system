...
<Meta
  title="Getting-Started/Vue/Usage"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<form @submit.prevent="submit">
  <BalField expanded :disabled="isFirstNameDisabled">
    ...
    <BalFieldControl>
      <BalInput v-model="firstName" :name="firstNameName" :placeholder="$t('form.firstName.placeholder')" :disabled="isFirstNameDisabled"></BalInput>
    </BalFieldControl>

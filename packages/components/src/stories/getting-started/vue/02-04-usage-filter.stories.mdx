...
<script setup lang="ts">
  ...
  const formattedClaimNumber = computed(() => balClaimNumber(claimNumber.value))
</script>

<template>
  <p>{{ formattedClaimNumber }}</p>
</template>
```

<bal-doc-github link="/stories/getting-started/vue/02-04-usage-filter.stories.mdx"></bal-doc-github>

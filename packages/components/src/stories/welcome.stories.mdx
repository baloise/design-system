                ...
                <div class="column">
                  <bal-card fullheight class="p-none" color="green-2">
                    <bal-card-content>
                      ...
                      <bal-text space="none">
                        In version 14, we've introduced z-index values as design tokens. Consequently, adjustments
                        were made to each component. If you've been using custom z-index values in your app, please
                        be aware that this could potentially result in broken layouts. After upgrading the design system
                        in your app, please take a moment to check if any layouts are affected. If necessary, make
                        adjustments to the z-index accordingly.
                      </bal-text>
                      <a
                        class="button is-primary mt-normal"
                        style={{ width: 'auto' }}
                        href="?path=/docs/development-upgrade-guides-updating-to-v14--page"
                      >
                        Upgrade Guide
                      </a>
                    </bal-card-content>

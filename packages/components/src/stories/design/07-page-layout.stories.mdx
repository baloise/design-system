...
- The `.container` is a simple utility class that allows you to center content on larger viewports and to reduce the main space.
  - Use `container is-compact` for calculator application to reduce the max-width to 768px.
...
- `.has-background` gives the app a light grey background to give a bit contrast to the white cards.

## Templates

Select the template that matches your case the best and start with that.
...
<div className="link-list">
  <a className="link-item" href="?path=/story/design-page-templates--external-calculator">
    ...
    <span>
      <strong>External Calculator Application</strong>A narrow template created for our calculators. Optimized for
      mobile usage.
    </span>
  </a>
  <a className="link-item" href="?path=/story/design-page-templates--external-calculator">

...
```html
<body>
  <bal-app class="has-sticky-footer has-background-grey-1">
...
- `.has-background-grey-1` gives the app a light grey background to give a bit contrast to the white cards.

...
The build script is devided into 3 phases:

- **Pre Build**
  - Build resources like icons and fonts for the design system
- **Core Build**
  - Builds the components and the global stylesheet
  - Depends on icons and fonts
- **Post Build**
  - Builds the proxy libraries, extensions and the testing library
  - Depends on components and global stylesheet

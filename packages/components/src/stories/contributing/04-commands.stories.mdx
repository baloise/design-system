...
> **Important**
> Changes on the components interface (prop, events and methods) will not be published in the debug mode. Therefore we need to build the stencil components with `npm run dev:build`.
...
<bal-doc-github link="D:/Baloise/projects/baloise-incubator/design-system/packages/components/src/stories/contributing/04-commands.stories.mdx"></bal-doc-github>

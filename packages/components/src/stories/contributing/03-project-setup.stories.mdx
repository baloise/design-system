...
│  │        │  ├── docs.stories.ts # has the different variants/stories of the component
│  │        │  ├── examples.docs.ts # HTML templates snippets <optional>
│  │        │  ├── readme.docs.mdx # main documentation file
│  │        │  ├── github.md # generated file with the contribution links

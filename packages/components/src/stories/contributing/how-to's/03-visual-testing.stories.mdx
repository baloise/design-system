...
6 steps are needed to finish a visual test for a component.
...
Now change the `CHANGELOG.md` to retrigger the build on your PR.
Like remove an empty line or add one.

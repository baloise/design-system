...
- [GitHub Issue](https://github.com/baloise-incubator/design-system/issues/497)
...
- [GitHub Issue](https://github.com/baloise-incubator/design-system/issues/486)
...
import { BaloiseDesignSystemModule } from '@baloise/design-system-next-components-angular'
...
import { BalCoreModule, BalButtonModule, BalHeadingModule } from '@baloise/design-system-next-components-angular'

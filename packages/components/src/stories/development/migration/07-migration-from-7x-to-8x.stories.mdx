...
<Meta
  title="Development/Migration/Migration from 7.x to 8.x"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-github link="/stories/development/migration/07-migration-from-7x-to-8x.stories.mdx"></bal-doc-github>

...
<Meta
  title="Development/Migration/Migration from 1.x to 2.x"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-github link="/stories/development/migration/01-migration-from-1x-to-2x.stories.mdx"></bal-doc-github>

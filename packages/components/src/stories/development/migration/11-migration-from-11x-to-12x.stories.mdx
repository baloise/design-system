...
global style file by 44%. Now styles of the components are loaded, when they are used.

If you are customize the styles through our SASS variables you need to change from lazy-loading to eager load the component styles.

...
<Meta
  title="Guides/Migration/Migration 11.x to 12.x"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
- [Cypress v11.2.0](https://docs.cypress.io/guides/references/changelog#11-2-0)
...
<bal-doc-github link="/stories/Guides/Migration/11-migration-from-11x-to-12x.stories.mdx"></bal-doc-github>

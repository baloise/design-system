...
Checkout our migration example project with Angular [GitHub](https://github.com/baloise/design-system-ng-migrations). There we migrated from v11 to v12 with the below mentioned breaking changes.
...
Minimal changes setup => [GitHub Repo](https://github.com/baloise/design-system-ng-migrations)

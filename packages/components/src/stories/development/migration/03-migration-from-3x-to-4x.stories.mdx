...
<Meta
  title="Development/Migration/Migration from 3.x to 4.x"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
[Go to the spacing chapter](?path=/docs/foundation-spacing--paddings)

<bal-doc-github link="/stories/development/migration/03-migration-from-3x-to-4x.stories.mdx"></bal-doc-github>

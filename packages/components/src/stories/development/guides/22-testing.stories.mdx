...
<Meta
  title="Development/Guides/Testing"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-banner id="testing" subtitle="Guides">Testing</bal-doc-banner>

<bal-doc-lead>
The Baloise Design System provides a collection of custom cypress commands for our components.
Moreover, some basic cypress commands like <b>should</b> or <b>click</b> have been overridden to work with our components.
</bal-doc-lead>

...
<Meta
  title="Development/Guides/Troubleshooting"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-banner id="troubleshooting" subtitle="Guides">Troubleshooting</bal-doc-banner>
...
<bal-doc-github link="/stories/development/guides/99-troubleshooting.stories.mdx"></bal-doc-github>

...
<Meta
  title="Development/Implementation/Internationalization"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-github link="/stories/development/implementation/20-internationalization.stories.mdx"></bal-doc-github>

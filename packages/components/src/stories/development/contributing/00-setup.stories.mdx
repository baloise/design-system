...
<Meta
  title="Development/Contributing/Setup"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
```bash
git clone https://github.com/baloise-incubator/design-system.git design-system
cd design-system
```
...
<bal-doc-github link="/stories/Development/Contributing/02-dev-setup.stories.mdx"></bal-doc-github>

...
<Meta
  title="Development/Contributing/How to's/Controller"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-github link="/stories/development/contributing/how-to's/01-controller.stories.mdx"></bal-doc-github>

...
<Meta
  title="Development/Contributing/How to's/Visual Testing"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
- `<main class="container py-medium">` each app should have a container, wo we test that as well
...
<bal-doc-github link="/stories/development/contributing/how-to's/03-visual-testing.stories.mdx"></bal-doc-github>

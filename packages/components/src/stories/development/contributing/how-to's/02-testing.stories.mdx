...
<Meta
  title="Development/Contributing/How to's/Testing Command"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
<bal-doc-github link="/stories/development/contributing/how-to's/02-testing.stories.mdx"></bal-doc-github>

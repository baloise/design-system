...
import LibraryImage from '../../../../public/assets/images/architecture/library.svg'
import DocumentationImage from '../../../../public/assets/images/architecture/documentation.svg'

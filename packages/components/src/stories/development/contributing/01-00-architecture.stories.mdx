...
<Meta
  title="Development/Contributing/Architecture"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
Bulma's components are well-documented and have simplified css classes. Every class name is human readable. Moreover, they provide some really good starter templates.
...
Of course, not everyone likes the theme of bulma. No problem, just import the variables.sass file and change the colors. Each component has its own sass variables, which can be easily changed to design a new theme.

### SWOT analysis of Bulma
...
<bal-doc-github link="/stories/development/contributing/01-00-architecture.stories.mdx"></bal-doc-github>

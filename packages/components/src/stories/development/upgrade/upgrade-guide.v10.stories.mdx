...
<Meta
  title="Development/Upgrade Guides/Updating to v10"
  parameters={{
    previewTabs: {
      canvas: { hidden: true },
    },
...
# Updating to Design System v10

<bal-doc-lead>Updating from v1 to v10</bal-doc-lead>
...
The unsupported browsers has been moved to [@baloise/web-app-unsupported-browsers](https://github.com/baloise/web-app-utils/tree/main/packages/unsupported-browsers).
...
<bal-doc-github link="/stories/development/upgrade/upgrade-guide.archived.stories.mdx"></bal-doc-github>

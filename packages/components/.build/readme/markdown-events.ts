...
export const eventsToMarkdown = (events: d.JsonDocsEvent[]) => {
  ...
  content.push(`#### Events`)
  content.push(``)
  content.push(`Follow the [Event Usage](https://baloise-design-v10.vercel.app/?path=/docs/implementation-event--page) guide to learn how to listen to component events.`)
  content.push(``)

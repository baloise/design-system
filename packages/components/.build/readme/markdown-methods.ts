...
export const methodsToMarkdown = (methods: d.JsonDocsMethod[]) => {
  ...
  content.push(``)
  content.push(`Follow the [Method Usage](https://baloise-design-v10.vercel.app/?path=/docs/implementation-method--page) guide to learn how to call component methods.`)
  content.push(``)

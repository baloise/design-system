...
describe('designSystemGridTheme', () => {
  it('binds accentColor to the primary background token', () => {
    expect(designSystemGridThemeParams.accentColor).toBe('var(--ds-alias-background-color-primary)')
  })

  it('binds fontFamily to the body text font token', () => {
    expect(designSystemGridThemeParams.fontFamily).toBe('var(--ds-alias-text-family-body)')
  })

  it('binds headerFontFamily to the heading text font token', () => {
    expect(designSystemGridThemeParams.headerFontFamily).toBe('var(--ds-alias-text-family-heading)')
  })
  ...
  it('binds the header background to the same token as the row background, and makes header text bold', () => {
    ...
    expect(designSystemGridThemeParams.headerFontWeight).toBe('var(--ds-alias-text-weight-bold)')
  })

  it('binds row hover and selection colors to the ds-table row tokens', () => {
    expect(designSystemGridThemeParams.rowHoverColor).toBe('var(--ds-table-row-background-color-hover)')
    expect(designSystemGridThemeParams.selectedRowBackgroundColor).toBe('var(--ds-table-row-background-color-active)')
  })
  ...
  it('binds checkbox colors and shape to the ds-checkbox tokens', () => {
    ...
    expect(designSystemGridThemeParams.checkboxCheckedBackgroundColor).toBe('var(--ds-alias-background-color-primary)')
    ...
    expect(designSystemGridThemeParams.checkboxIndeterminateBackgroundColor).toBe(

...
interface IconAccessorType
  extends Andable<IconAccessorType>,
    Blurable<IconAccessorType>,
    Existable<IconAccessorType>,
    Containable<IconAccessorType>,
    Clickable<IconAccessorType>,
    Shouldable<IconAccessorType>,
    Visible<IconAccessorType>,
    NthSelectable<IconAccessorType>,
    Attributable<IconAccessorType>,
    Urlable<IconAccessorType>,
    Findable<IconAccessorType>,
    Waitable<IconAccessorType>,
    Invokable<IconAccessorType>,
    Thenable<IconAccessorType>,
    Lengthable<IconAccessorType>,
    Eachable<IconAccessorType> {
  assertIcon(id: string): IconAccessorType
}

export const LibIconAssertableMixin: Mixin = <T>({ element, creator }: MixinContext<T>) => ({
...
export const IconAccessor: Accessor<IconAccessorType> = createAccessor<IconAccessorType>(
  AndableMixin,
  BlurableMixin,
  LibIconAssertableMixin,
  ExistableMixin,
  ContainableMixin,
  ClickableMixin,
  ShouldableMixin,

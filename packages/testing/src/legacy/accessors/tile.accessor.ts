...
interface TileAccessorType
  extends Andable<TileAccessorType>,
    Clickable<TileAccessorType>,
    Existable<TileAccessorType>,
    Containable<TileAccessorType>,
    Disableable<TileAccessorType>,
    Shouldable<TileAccessorType>,
    Visible<TileAccessorType>,
    NthSelectable<TileAccessorType>,
    Attributable<TileAccessorType>,
    Urlable<TileAccessorType>,
    Findable<TileAccessorType>,
    Waitable<TileAccessorType>,
    Invokable<TileAccessorType>,
    Thenable<TileAccessorType>,
    Lengthable<TileAccessorType>,
    Eachable<TileAccessorType>,
    Attachable<TileAccessorType> {
...
export const TileContainableMixin: Mixin = <T>({ element, creator }: MixinContext<T>) => ({
...
export const TileAccessor: Accessor<TileAccessorType> = createAccessor<TileAccessorType>(
  AndableMixin,
  TileClickableMixin,
  TileContainableMixin,
  ExistableMixin,
  DisableableMixin,
  ShouldableMixin,
  VisibleMixin,

...
interface TableAccessorType
  extends Andable<TableAccessorType>,
    Clickable<TableAccessorType>,
    Containable<TableAccessorType>,
    Existable<TableAccessorType>,
    Shouldable<TableAccessorType>,
    Disableable<TableAccessorType>,
    Visible<TableAccessorType>,
    NthSelectable<TableAccessorType>,
    Attributable<TableAccessorType>,
    Urlable<TableAccessorType>,
    Findable<TableAccessorType>,
    Waitable<TableAccessorType>,
    Eachable<TableAccessorType>,
    Invokable<TableAccessorType>,
    Thenable<TableAccessorType>,
    Lengthable<TableAccessorType>,
    Attachable<TableAccessorType> {
...
export const TableRowClickableMixin: Mixin = <T>({ element, creator }: MixinContext<T>) => ({
  clickOnRow: (index: number, options?: Partial<Cypress.ClickOptions>) => {
    const row = element.find('tr').eq(index)
    row.click(options)
    return creator()
  },
})
export const TableRowContainableMixin: Mixin = <T>({ element, creator }: MixinContext<T>) => ({
...
export const TableAccessor: Accessor<TableAccessorType> = createAccessor<TableAccessorType>(
  AndableMixin,
  TableRowClickableMixin,
  TableRowContainableMixin,
  ExistableMixin,
  ContainableMixin,
  ClickableMixin,
  ShouldableMixin,

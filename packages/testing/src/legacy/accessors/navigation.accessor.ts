...
interface NavigationAccessorType
  extends Andable<NavigationAccessorType>,
    Clickable<NavigationAccessorType>,
    Disableable<NavigationAccessorType>,
    Existable<NavigationAccessorType>,
    Selectable<NavigationAccessorType>,
    Containable<NavigationAccessorType>,
    Shouldable<NavigationAccessorType>,
    Visible<NavigationAccessorType>,
    NthSelectable<NavigationAccessorType>,
    Attributable<NavigationAccessorType>,
    Urlable<NavigationAccessorType>,
    Findable<NavigationAccessorType>,
    Waitable<NavigationAccessorType>,
    Invokable<NavigationAccessorType>,
    Thenable<NavigationAccessorType>,
    Lengthable<NavigationAccessorType>,
    Eachable<NavigationAccessorType> {}

export const NavigationAccessor: Accessor<NavigationAccessorType> = createAccessor<NavigationAccessorType>(
  AndableMixin,
  ListSelectableMixin,
  ExistableMixin,
  DisableableMixin,

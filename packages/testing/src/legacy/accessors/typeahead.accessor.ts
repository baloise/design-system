...
export interface TypeaheadAccessorType
  extends Andable<TypeaheadAccessorType>,
    Clickable<TypeaheadAccessorType>,
    Typeable<TypeaheadAccessorType>,
    Blurable<TypeaheadAccessorType>,
    Clearable<TypeaheadAccessorType>,
    Containable<TypeaheadAccessorType>,
    Selectable<TypeaheadAccessorType>,
    Shouldable<TypeaheadAccessorType>,
    NthSelectable<TypeaheadAccessorType>,
    Attributable<TypeaheadAccessorType>,
    Urlable<TypeaheadAccessorType>,
    Findable<TypeaheadAccessorType>,
    Waitable<TypeaheadAccessorType>,
    Invokable<TypeaheadAccessorType>,
    Thenable<TypeaheadAccessorType>,
    Lengthable<TypeaheadAccessorType>,
...
export const TypeaheadAccessor: Accessor<TypeaheadAccessorType> = createAccessor<TypeaheadAccessorType>(
  AndableMixin,
  ClickableMixin,
  TypeableMixin,
  BlurableMixin,

...
interface SelectButtonAccessorType
    extends Andable<SelectButtonAccessorType>, Blurable<SelectButtonAccessorType>, Selectable<SelectButtonAccessorType>, Containable<SelectButtonAccessorType>,
        Clickable<SelectButtonAccessorType>, Existable<SelectButtonAccessorType>, Shouldable<SelectButtonAccessorType>, Visible<SelectButtonAccessorType>,
        Disableable<SelectButtonAccessorType>, NthSelectable<SelectButtonAccessorType>, Attributable<SelectButtonAccessorType>,
        Urlable<SelectButtonAccessorType>, Findable<SelectButtonAccessorType>, Waitable<SelectButtonAccessorType>, Invokable<SelectButtonAccessorType>,
        Thenable<SelectButtonAccessorType>, Lengthable<SelectButtonAccessorType>, Eachable<SelectButtonAccessorType> {
}
...
export const SelectButtonAccessor: Accessor<SelectButtonAccessorType> =
    createAccessor<SelectButtonAccessorType>(AndableMixin, BlurableMixin, SelectButtonSelectableMixin, ContainableMixin, ClickableMixin, ExistableMixin,
        ShouldableMixin, VisibleMixin, DisableableMixin, NthSelectableMixin, AttributableMixin, UrlableMixin, WaitableMixin, FindableMixin, InvokableMixin,
        ThenableMixin, LengthableMixin, EachableMixin);

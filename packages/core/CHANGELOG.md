...
- **angular**: The design system now provides an Angular provider instead of the BaloiseDesignSystemModule. ( [#1853](https://github.com/baloise/design-system/pull/1853))
...
- **core**: improve slot handling ( [#1856](https://github.com/baloise/design-system/pull/1856))

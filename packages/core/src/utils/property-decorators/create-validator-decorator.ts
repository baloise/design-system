 ...
 */
export function registerDependency(target: object, dependencyProp: string, dependentProp: string): void {
...
function patchComponentDidLoad(target: object): void {
  ...
  const original =
    'componentDidLoad' in target && typeof target.componentDidLoad === 'function' ? target.componentDidLoad : undefined
 ...
 */
export function createValidatorDecorator(validator: Validator): (target: object, property: string) => void {

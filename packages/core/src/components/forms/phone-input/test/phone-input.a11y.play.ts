...
test('default', async ({ page, a11y }) => {
  ...
  await a11y('ds-phone-input')
})

test('with value', async ({ page, a11y }) => {
  await page.mount(`<ds-phone-input label="Phone number" initial-country="CH" value="+41791234567"></ds-phone-input>`)
  await a11y('ds-phone-input')
})

test('with placeholder', async ({ page, a11y }) => {
  await page.mount(
    `<ds-phone-input label="Phone number" initial-country="CH" placeholder="79 501 21 22"></ds-phone-input>`,
  )
  await a11y('ds-phone-input')
})

test('restricted countries', async ({ page, a11y }) => {
  await page.mount(`<ds-phone-input label="Phone number" countries="CH,DE,FR,IT"></ds-phone-input>`)
  await a11y('ds-phone-input')
})
...
test('semantics and keyboard navigation', async ({ page }) => {
  await page.mount(
    `<ds-phone-input label="Phone number" countries="CH,DE,FR,IT" initial-country="CH"></ds-phone-input>`,
  )
  const phone = new DsPhoneInput(page.locator('ds-phone-input'))
...
test('disabled', async ({ page, a11y }) => {
  await page.mount(
    `<ds-phone-input label="Phone number" initial-country="CH" value="+41791234567" disabled></ds-phone-input>`,
  )
  await a11y('ds-phone-input')
})
...
test('invalid', async ({ page, a11y }) => {
  await page.mount(
    `<ds-phone-input label="Phone number" initial-country="CH" invalid invalid-text="Please enter a phone number"></ds-phone-input>`,
  )
  await a11y('ds-phone-input')
})

test('success', async ({ page, a11y }) => {
  await page.mount(`<ds-phone-input label="Phone number" initial-country="CH" color="success"></ds-phone-input>`)
  await a11y('ds-phone-input')
})

test('warning', async ({ page, a11y }) => {
  await page.mount(`<ds-phone-input label="Phone number" initial-country="CH" color="warning"></ds-phone-input>`)
  await a11y('ds-phone-input')
})

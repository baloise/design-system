...
import { clampValue, resolveInitialValue } from './slider.utils'
import { SliderPickerController } from './slider.picker'
...
@Component({
  tag: 'ds-slider',
  styleUrl: 'slider.host.scss',
  shadow: true,
  formAssociated: true,
})
export class Slider implements DsComponentInterface, FieldInterface {
  private inheritedAttributes: { [k: string]: any } = {}
  private sliderEl: NoUiSliderTarget | undefined
  private picker: SliderPickerController | undefined
  private initialValue: number = NaN

  sliderId = `ds-slider-${SliderIds++}`
  ...
  @Prop({ reflect: true })
  @Type('string')
  readonly name: string = this.sliderId
   ...
   */
  @Prop()
  @OneOf(SLIDER_BRAND_COLORS)
  readonly brandColor?: SliderBrandColor
   ...
   */
  @Event() dsInput!: EventEmitter<SliderInputDetail>

  /**
   * Emitted when the input has focus.
   */
  @Event() dsFocus!: EventEmitter<SliderFocusDetail>

  /**
   * Emitted when the input loses focus.
   */
  @Event() dsBlur!: EventEmitter<SliderBlurDetail>

  /**
   * Emitted when the input is clicked.
   */
  @Event() dsClick!: EventEmitter<SliderClickDetail>
   ...
   */
  @Event() dsChange!: EventEmitter<SliderChangeDetail>
  ...
  componentDidLoad() {
    ...
    this.picker = new SliderPickerController({
  ...
  /**
   * Sets focus on `ds-slider`'s slider handle. Use this method instead of the global
   * `element.focus()`.
   */
  @Method()
  async setFocus() {
  ...
  /**
   * Sets blur on `ds-slider`'s slider handle. Use this method instead of the global
   * `element.blur()`.
   * @internal
   */
  @Method()

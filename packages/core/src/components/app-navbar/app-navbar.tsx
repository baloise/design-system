...
import { i18nDsAppNavbar } from './app-navbar.i18n'
import { APP_NAVBAR_CONTAINERS, AppNavbarContainer } from './app-navbar.interfaces'
...
@Component({
  tag: 'ds-app-navbar',
  styleUrl: 'app-navbar.host.scss',
  shadow: true,
})
export class AppNavbar implements DsComponentInterface, DsBreakpointObserver, DsConfigObserver, ResizeObserver {
  ...
  private checkAppNavbarOverflow(): void {
  ...
  render() {
    ...
    const i18n = i18nDsAppNavbar[this.language]

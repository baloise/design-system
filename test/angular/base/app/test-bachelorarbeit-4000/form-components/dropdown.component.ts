        ...
        <bal-field required>
          ...
          <bal-field-control>
            <bal-dropdown
              ...
              [typeahead]="typeahead"
            >
              <bal-option *ngFor="let option of options" [label]="option" [value]="option">{{ option }}</bal-option>
            </bal-dropdown>
          </bal-field-control>
          <bal-field-message>
...
export class DropdownComponent {
  ...
  get label() {
    return this.multiple ? 'Dropdown Multiple' : 'Dropdown'
  }

  get control() {
    return this.multiple ? 'dropdownMultiple' : 'dropdown'
  }

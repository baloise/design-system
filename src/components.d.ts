...
declare global {
  interface HTMLBalAccordionElement
    extends Components.BalAccordion,
      HTMLStencilElement {}
  var HTMLBalAccordionElement: {
    prototype: HTMLBalAccordionElement
    new (): HTMLBalAccordionElement
  }
  interface HTMLBalButtonElement
    extends Components.BalButton,
      HTMLStencilElement {}
  ...
  interface HTMLBalHintTextElement
    extends Components.BalHintText,
      HTMLStencilElement {}
  var HTMLBalHintTextElement: {
    prototype: HTMLBalHintTextElement
    new (): HTMLBalHintTextElement
  }
  interface HTMLBalHintTitleElement
    extends Components.BalHintTitle,
      HTMLStencilElement {}
  ...
  interface HTMLBalStepsElement
    extends Components.BalSteps,
      HTMLStencilElement {}
  var HTMLBalStepsElement: {
    prototype: HTMLBalStepsElement
    new (): HTMLBalStepsElement
  }
  interface HTMLBalTabItemElement
    extends Components.BalTabItem,
      HTMLStencilElement {}
  ...
  interface HTMLBalTimeinputElement
    extends Components.BalTimeinput,
      HTMLStencilElement {}
  var HTMLBalTimeinputElement: {
    prototype: HTMLBalTimeinputElement
    new (): HTMLBalTimeinputElement
  }
  interface HTMLBalToastElement
    extends Components.BalToast,
      HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface BalFileUpload {
     ...
     */
    onBalFileUploadRejectedFile?: (
      event: CustomEvent<FileUploadRejectedFile>,
    ) => void
  }
  interface BalFilterButton {
    /**
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      "bal-accordion": LocalJSX.BalAccordion &
        JSXBase.HTMLAttributes<HTMLBalAccordionElement>
      "bal-button": LocalJSX.BalButton &
        JSXBase.HTMLAttributes<HTMLBalButtonElement>
      "bal-card": LocalJSX.BalCard & JSXBase.HTMLAttributes<HTMLBalCardElement>
      "bal-card-actions": LocalJSX.BalCardActions &
        JSXBase.HTMLAttributes<HTMLBalCardActionsElement>
      "bal-card-button": LocalJSX.BalCardButton &
        JSXBase.HTMLAttributes<HTMLBalCardButtonElement>
      "bal-card-content": LocalJSX.BalCardContent &
        JSXBase.HTMLAttributes<HTMLBalCardContentElement>
      "bal-card-heading": LocalJSX.BalCardHeading &
        JSXBase.HTMLAttributes<HTMLBalCardHeadingElement>
      "bal-card-step": LocalJSX.BalCardStep &
        JSXBase.HTMLAttributes<HTMLBalCardStepElement>
      "bal-card-steps": LocalJSX.BalCardSteps &
        JSXBase.HTMLAttributes<HTMLBalCardStepsElement>
      "bal-card-subtitle": LocalJSX.BalCardSubtitle &
        JSXBase.HTMLAttributes<HTMLBalCardSubtitleElement>
      "bal-card-title": LocalJSX.BalCardTitle &
        JSXBase.HTMLAttributes<HTMLBalCardTitleElement>
      "bal-data": LocalJSX.BalData & JSXBase.HTMLAttributes<HTMLBalDataElement>
      "bal-data-item": LocalJSX.BalDataItem &
        JSXBase.HTMLAttributes<HTMLBalDataItemElement>
      "bal-data-label": LocalJSX.BalDataLabel &
        JSXBase.HTMLAttributes<HTMLBalDataLabelElement>
      "bal-data-value": LocalJSX.BalDataValue &
        JSXBase.HTMLAttributes<HTMLBalDataValueElement>
      "bal-datepicker": LocalJSX.BalDatepicker &
        JSXBase.HTMLAttributes<HTMLBalDatepickerElement>
      "bal-datetimepicker": LocalJSX.BalDatetimepicker &
        JSXBase.HTMLAttributes<HTMLBalDatetimepickerElement>
      "bal-dropdown": LocalJSX.BalDropdown &
        JSXBase.HTMLAttributes<HTMLBalDropdownElement>
      "bal-dropdown-option": LocalJSX.BalDropdownOption &
        JSXBase.HTMLAttributes<HTMLBalDropdownOptionElement>
      "bal-field": LocalJSX.BalField &
        JSXBase.HTMLAttributes<HTMLBalFieldElement>
      "bal-file-upload": LocalJSX.BalFileUpload &
        JSXBase.HTMLAttributes<HTMLBalFileUploadElement>
      "bal-filter-button": LocalJSX.BalFilterButton &
        JSXBase.HTMLAttributes<HTMLBalFilterButtonElement>
      "bal-hint": LocalJSX.BalHint & JSXBase.HTMLAttributes<HTMLBalHintElement>
      "bal-hint-text": LocalJSX.BalHintText &
        JSXBase.HTMLAttributes<HTMLBalHintTextElement>
      "bal-hint-title": LocalJSX.BalHintTitle &
        JSXBase.HTMLAttributes<HTMLBalHintTitleElement>
      ...
      "bal-list-item": LocalJSX.BalListItem &
        JSXBase.HTMLAttributes<HTMLBalListItemElement>
      "bal-list-item-content": LocalJSX.BalListItemContent &
        JSXBase.HTMLAttributes<HTMLBalListItemContentElement>
      "bal-list-item-icon": LocalJSX.BalListItemIcon &
        JSXBase.HTMLAttributes<HTMLBalListItemIconElement>
      "bal-list-item-subtitle": LocalJSX.BalListItemSubtitle &
        JSXBase.HTMLAttributes<HTMLBalListItemSubtitleElement>
      "bal-list-item-title": LocalJSX.BalListItemTitle &
        JSXBase.HTMLAttributes<HTMLBalListItemTitleElement>
      "bal-modal": LocalJSX.BalModal &
        JSXBase.HTMLAttributes<HTMLBalModalElement>
      "bal-modal-actions": LocalJSX.BalModalActions &
        JSXBase.HTMLAttributes<HTMLBalModalActionsElement>
      "bal-navbar": LocalJSX.BalNavbar &
        JSXBase.HTMLAttributes<HTMLBalNavbarElement>
      "bal-pagination": LocalJSX.BalPagination &
        JSXBase.HTMLAttributes<HTMLBalPaginationElement>
      "bal-spinner": LocalJSX.BalSpinner &
        JSXBase.HTMLAttributes<HTMLBalSpinnerElement>
      "bal-step": LocalJSX.BalStep & JSXBase.HTMLAttributes<HTMLBalStepElement>
      "bal-steps": LocalJSX.BalSteps &
        JSXBase.HTMLAttributes<HTMLBalStepsElement>
      "bal-tab-item": LocalJSX.BalTabItem &
        JSXBase.HTMLAttributes<HTMLBalTabItemElement>
      ...
      "bal-timeinput": LocalJSX.BalTimeinput &
        JSXBase.HTMLAttributes<HTMLBalTimeinputElement>
      "bal-toast": LocalJSX.BalToast &
        JSXBase.HTMLAttributes<HTMLBalToastElement>
    }
  }
}

...
<div class="columns">
  <div class="column">
    <bal-icon name="date" is-font="true" size="small"></bal-icon>
  </div>
  <div class="column">
...
<div class="columns">
  <div class="column">
    <bal-icon name="date" is-font="true"></bal-icon>
  </div>
  <div class="column">
...
<div class="columns">
  <div class="column">
    <bal-icon name="date" is-font="true" size="medium"></bal-icon>
  </div>
  <div class="column">
...
<div class="columns">
  <div class="column">
    <bal-icon name="date" is-font="true" size="large"></bal-icon>
  </div>
  <div class="column">
...
| <bal-icon name="edit" size="medium" /> | <bal-icon  style="--bal-icon-color:red" name="edit" is-font="true" size="medium"></bal-icon> |`edit` |   
| <bal-icon name="date" size="medium" /> | <bal-icon  style="color:red" name="date" is-font="true" size="medium"></bal-icon> |`date` |   

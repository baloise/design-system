...
| **React Bindings**     | `packages/react/CONTEXT.md`      | Generated React wrappers, overlay idioms, `DsContext`                                   |
...
- Working on framework bindings → read `packages/react/CONTEXT.md` or `packages/angular/CONTEXT.md`, both generated by stock Stencil output targets (see ADR-0003, ADR-0006); React overlay idioms are documented in ADR-0028

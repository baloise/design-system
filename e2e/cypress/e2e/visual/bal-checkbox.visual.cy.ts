describe('bal-checkbox', () => {
  ...
  it('basic component', () => {
    ...
    cy.getByTestId('button').testVisual('checkbox-button-desktop')
    ...
    cy.getByTestId('long-label-button').testVisual('checkbox-long-label-button-desktop', {
      errorThreshold: 0.3,
    })
    cy.getByTestId('long-label-checked').testVisual('checkbox-long-label-checked-desktop', { errorThreshold: 0.3 })
    cy.getByTestId('long-label-button-checked').testVisual('checkbox-long-label-button-checked-desktop', {
      errorThreshold: 0.3,
    })

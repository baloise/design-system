...
describe('bal-field-horizontal', () => {
  ...
  it('basic component', () => {
    ...
    cy.getByTestId('horizontal-with-hint-hidden').click().balHintFindOverlay().testVisual('horizontal-with-hint-hidden-desktop')
    ...
    cy.getByTestId('horizontal-with-hint-hidden').click().balHintFindOverlay().testVisual('horizontal-with-hint-hidden-tablet')
    ...
    cy.getByTestId('horizontal-with-hint-hidden').click().balHintFindOverlay().testVisual('horizontal-with-hint-hidden-mobile')

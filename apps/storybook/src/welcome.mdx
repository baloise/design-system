  ...
  <div className="flex gap-base mt-lg">
    <div className="flex-1 flex flex-direction-column gap-base">
      <button
        ...
        className="button is-brand-green flex gap-base justify-content-center align-items-center p-base w-full"
      >
      ...
      <button
        ...
        className="button is-brand-red flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-right">
    ...
    <div className="flex-1 flex flex-direction-column gap-base">
      <button
        ...
        className="button is-brand-yellow flex gap-base justify-content-center align-items-center p-base w-full"
      >
      ...
      <button
        ...
        className="button is-brand-purple flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-left">

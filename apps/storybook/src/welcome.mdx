...
<Unstyled>
  <div className="flex gap-lg mt-3xl">
    <div className="flex flex-1 justify-content-center align-items-center flex-direction-column">
      ...
      <h2 className="ds-subtitle text-5xl mt-sm">design system</h2>
    </div>
  </div>
  <p className="text-xl text-primary-light mt-base text-align-center font-weight-bold">Pieces that fit together.</p>
</Unstyled>
  ...
  <div className="flex gap-base mt-lg">
    <div className="flex-1 flex flex-direction-column gap-base">
      <button
        ...
        className="ds-button is-brand-green flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-right">
          <h2 className="ds-title text-xl mb-xs">Tokens</h2>
          <span className="ds-text mobile:hidden">
            Named values that store every visual design decision in one place.
          </span>
        </div>
      </button>
      <button
        onClick={() => navigate({ title: 'CSS Utilities' })}
        className="ds-button is-brand-red flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-right">
          <h2 className="ds-title text-xl mb-xs">CSS Utilities</h2>
          <span className="ds-text mobile:hidden">Pre-built classes to style elements without writing custom CSS.</span>
        </div>
      </button>
    </div>
    ...
    <div className="flex-1 flex flex-direction-column gap-base">
      <button
        ...
        className="ds-button is-brand-yellow flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-left">
          <h2 className="ds-title text-xl mb-xs">Foundations</h2>
          <span className="ds-text mobile:hidden">Core visual principles that shape layouts and user experiences.</span>
        </div>
      </button>
      <button
        onClick={() => navigate({ title: 'Components' })}
        className="ds-button is-brand-purple flex gap-base justify-content-center align-items-center p-base w-full"
      >
        <div className="text-align-left">
          <h2 className="ds-title text-xl mb-xs">Components</h2>
          <span className="ds-text mobile:hidden">Over 50 accessible, framework-agnostic UI building blocks.</span>
        </div>
      </button>
    </div>
  </div>
...
<Unstyled>
  <span className="text-lg block mt-xl text-align-center">
    Built with accessibility and simplicity in mind, the Helvetia Design System provides UI components <br /> and a
    clearly defined visual style for building web applications.
  </span>
</Unstyled>
...
<Unstyled>
  <div className="flex gap-base flex-wrap mt-xl align-items-center justify-content-center mb-4xl">
    ...
    <a className="ds-button is-secondary" href="https://github.com/baloise/design-system" target="_blank">
      <svg
        width="24px"
        height="24px"
        viewBox="0 0 14 14"
    ...
    <a className="ds-button is-secondary" style={{ width: 'auto' }} onClick={() => navigate({ title: 'Support' })}>
      Report an Issue
    </a>
  </div>
</Unstyled>
...
<Unstyled>
  ...
  >
    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
      <h2 className="ds-title is-2xl mb-md">Advantages</h2>
      <p>In this section key advantages of the library are listed which are part of the Helvetia Design System.</p>
      <div className="ds-grid is-multiline mt-md" style={{ '--ds-column-gap': '.5rem' }}>
  ...
  <div className="flex gap-lg flex-wrap my-lg">
    {[
      ...
      },
      {
        ...
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 223 236" width="48" className="angular-logo">
            <g clipPath="url(#frameworks-a)">
              <path
      ...
      },
      {
        ...
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 512 512">
            ...
            <path fill="#EBEBEB" d="M256 208h-75l-5-58h80V94H114l15 171h127zm0 147-63-17-4-45h-56l7 89 116 32z" />
            <path fill="#FFF" d="M255 208v57h70l-7 74-63 17v59l116-32 16-174zm0-114v56h137l5-56z" />
          </svg>
        ),
      },
      ...
      <div
        key={name}
        className="ds-card flex flex-direction-column align-items-center gap-xs text-align-center flex-1"
        style={{ minWidth: '160px' }}
      >
        <div className="ds-tech-icon">{icon}</div>
        <span className="ds-title text-sm mt-xs">{name}</span>
...
<Unstyled>
  <div className="ds-grid is-multiline mt-lg" style={{ '--ds-column-gap': '.5rem', '--ds-row-gap': '1rem' }}>
    <div className="ds-col tablet:is-6 desktop:is-3">
      <a
        href="https://stenciljs.io/"
        target="_blank"
        rel="noopener noreferrer"
        className="ds-button is-secondary flex gap-base flex-direction-column w-full justify-content-center align-items-center p-base h-full "
        title="Stencil.js"
      >
    ...
    <div className="ds-col tablet:is-6 desktop:is-3">
      ...
      >
        <div className="ds-tech-icon">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 223 236" width="32" className="angular-logo">
            <g clipPath="url(#a)">
              <path
                fill="url(#b)"
                d="m222.077 39.192-8.019 125.923L137.387 0l84.69 39.192Zm-53.105 162.825-57.933 33.056-57.934-33.056 11.783-28.556h92.301l11.783 28.556ZM111.039 62.675l30.357 73.803H80.681l30.358-73.803ZM7.937 165.115 0 39.192 84.69 0 7.937 165.115Z"
      ...
      >
        <div className="ds-tech-icon">
          ...
          >
            ...
            <g id="icon-storybook-default" fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">

    ...
    <div className="flex-1 flex flex-direction-column gap-base">
      ...
      >
        <div className="text-align-right">
          ...
          <span className="ds-text mobile:hidden">Named values that store every visual design decision in one place.</span>
        </div>
      </button>
      <button
...
<Unstyled>
  ...
  >
    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div className="ds-grid is-multiline mt-medium" style={{ '--ds-column-gap': '.5rem' }}>
...
<Unstyled>
  <div className="flex gap-lg flex-wrap my-lg">
    {[
      ...
      <div
        key={name}
        className="ds-card flex flex-direction-column align-items-center gap-x-small text-align-center flex-1"

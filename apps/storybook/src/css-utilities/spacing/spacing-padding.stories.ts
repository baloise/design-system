...
export const SingleSidePadding = Story({
  ...
  <div class="pt-normal bg-red-2">
      <div class="bg-red p-large">pt-normal</div>
  </div>
  <div class="pr-large bg-red-2">
      <div class="bg-red p-large">pr-large</div>
  </div>
  <div class="pb-small bg-red-2">
      <div class="bg-red p-large">pb-small</div>
  </div>
  <div class="pl-medium bg-red-2">
      <div class="bg-red p-large">pl-medium</div>
  </div>
</div>`,
  ),
})
export const HorizontalPadding = Story({
  ...withRender(
    ...
    <div class="px-large bg-red-2 radius">
        <div class="radius bg-red font-weight-bold p-normal">px-large</div>
    </div>
</div>`,
  ),
})
export const VerticalPadding = Story({
  ...withRender(
    ...
    <div class="py-large bg-red-2 radius">
        <div class="radius bg-red font-weight-bold p-normal">py-large</div>
    </div>
</div>`,
  ),
})

...
export const Hidden = Story({
  ...
  <div class="hidden bg-red p-normal radius">1</div>
  <div class="bg-red p-normal radius">2</div>
  <div class="bg-red p-normal radius">3</div>
</div>`,
  ),
})
export const Block = Story({
  ...withRender(
    () => `<div class="block bg-red text-align-center p-normal radius mb-normal">1</div>
<div class="block bg-red text-align-center p-normal radius mb-normal">2</div>
<div class="block bg-red text-align-center p-normal radius mb-normal">3</div>`,
  ),
})
export const Inline = Story({
  ...withRender(
    () => `<div class="inline bg-red text-align-center p-normal radius mx-normal">1</div>
<div class="inline bg-red text-align-center p-normal radius">2</div>
<div class="inline bg-red text-align-center p-normal radius mx-normal">3</div>`,
  ),
})
export const InlineBlock = Story({
  ...withRender(
    () => `<div class="inline-block bg-red text-align-center p-normal radius">1</div>
<div class="inline-block bg-red text-align-center p-normal radius mx-normal">2</div>
<div class="inline-block bg-red text-align-center p-normal radius">3</div>`,
  ),
})
export const Flex = Story({
  ...withRender(
    () => `<div class="flex gap-normal">
    <div class="flex-1 bg-red text-align-center p-normal radius">1</div>
    <div class="flex-1 bg-red text-align-center p-normal radius">2</div>
    <div class="flex-1 bg-red text-align-center p-normal radius">3</div>
</div>`,
  ),
})

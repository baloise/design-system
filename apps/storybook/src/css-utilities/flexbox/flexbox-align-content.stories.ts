...
export const SpaceBetween = Story({
  ...withRender(
    ...
    <div class="bg-red radius flex justify-content-center align-items-center" style="height: 4rem; width: 200px">4</div>
    <div class="bg-red radius flex justify-content-center align-items-center" style="height: 4rem; width: 200px">5</div>
</div>`,
  ),
})

...
export const Row = Story({
  ...withRender(
    ...
    <div class="bg-red text-align-center radius p-normal">1</div>
    <div class="bg-red text-align-center radius p-normal">2</div>
    <div class="bg-red text-align-center radius p-normal">3</div>
</div>`,
  ),
})

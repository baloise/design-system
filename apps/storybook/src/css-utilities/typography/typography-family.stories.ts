...
export const TextFontFamily = Story({
  ...withRender(
    () => `<h1 class="ds-title font-family-text">Text - Lorem ipsum dolor sit.</h1>
<p>Text - Lorem ipsum dolor sit.</p>`,
  ),
})
export const TitleFontFamily = Story({
  ...withRender(
    () => `<h1 class="ds-title">Title - Lorem ipsum dolor sit.</h1>
<h1 class="ds-subtitle">Subtitle - Lorem ipsum dolor sit.</h1>

...
<Meta title="Components/Structure/Divider/Variants/Overview" name="Overview" />
...
<CanvasTabs htmlOf={DividerStories.DashedHtml} of={DividerStories.Dashed} />
...
<CanvasTabs htmlOf={DividerStories.VerticalHtml} of={DividerStories.Vertical} />

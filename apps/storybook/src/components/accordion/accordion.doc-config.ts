...
export const ACCORDION_DOC_CONFIG = {
  ...
  tabs: [
    { label: 'Overview', storyId: 'components-accordion-accordion--accordion' },
    { label: 'Usage', storyId: 'components-accordion-usage--usage' },
    { label: 'Variants', storyId: 'components-accordion-variants-overview--overview' },
    { label: 'Styling', storyId: 'components-accordion-styling--styling' },
    { label: 'Accessibility', storyId: 'components-accordion-accessibility--accessibility' },
    { label: 'Testing', storyId: 'components-accordion-testing--testing' },
  ],
}

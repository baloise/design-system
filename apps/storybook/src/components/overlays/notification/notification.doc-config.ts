...
export const NOTIFICATION_DOC_CONFIG = {
  ...
  color: 'red' as const,
  tabs: [
    { label: 'Overview', storyId: 'components-overlays-notification-notification--notification' },
    { label: 'Usage', storyId: 'components-overlays-notification-usage--usage' },
    { label: 'Variants', storyId: 'components-overlays-notification-variants-overview--overview' },
    { label: 'Styling', storyId: 'components-overlays-notification-styling--styling' },
    { label: 'Accessibility', storyId: 'components-overlays-notification-accessibility--accessibility' },
    { label: 'Testing', storyId: 'components-overlays-notification-testing--testing' },
  ],
}

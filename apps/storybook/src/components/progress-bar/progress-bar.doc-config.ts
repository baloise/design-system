...
export const PROGRESS_BAR_DOC_CONFIG = {
  ...
  tabs: [
    { label: 'Overview', storyId: 'components-progress-bar-progress-bar--progress-bar' },
    { label: 'Usage', storyId: 'components-progress-bar-usage--usage' },
    { label: 'Variants', storyId: 'components-progress-bar-variants-overview--overview' },
    { label: 'Styling', storyId: 'components-progress-bar-styling--styling' },
    { label: 'Accessibility', storyId: 'components-progress-bar-accessibility--accessibility' },
    { label: 'Testing', storyId: 'components-progress-bar-testing--testing' },
  ],
}

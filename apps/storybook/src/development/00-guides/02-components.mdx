...
import { DsHeading, DsRoot } from '@helvetia-design/angular'
...
import { DsRootProvider, DsHeading } from "@helvetia-design/react";
...
import { DsButton } from '@helvetia-design/react'
...
```ts
import { Component } from '@angular/core'
import type { InputInputDetail } from '@helvetia-design/core'
...
```tsx
import { useState } from 'react'
import { DsInput, DsText } from '@helvetia-design/react'
...
import type { Components } from '@helvetia-design/core'
import { ProxyComponent } from '@helvetia-design/angular'
...
import { DsSelect, DsButton } from '@helvetia-design/react'

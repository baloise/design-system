...
<InfoQuote>
  React provides a controlled `Modal` component and `useToast()` / `useSnackbar()` hooks for presenting overlays.
</InfoQuote>

<LinkCard
  pageTitle="Development/Overlays"
  description="Use modals, toasts, and snackbars in React."
/>

...
test('ds-phone-input renders and fires dsInput with an E.164 value', async ({ page }) => {
  await page.goto('/')
  ...
  // docs/adr/0033-ds-phone-input-bundled-svg-flags.md, which removed the runtime asset path this
